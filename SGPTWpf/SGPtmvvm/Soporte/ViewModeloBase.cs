...
namespace SGPTmvvm.Soporte
{
    ...
    public class ViewModeloBase : ViewModelBase, INotifyPropertyChanged, IDataErrorInfo
    {
        /// <summary>
        ...
        //Tomado de combobox datainding 04-10-2016
        ...
        [Conditional("DEBUG")]
        [DebuggerStepThrough]
        public  new void VerifyPropertyName(string propertyName)
        {
