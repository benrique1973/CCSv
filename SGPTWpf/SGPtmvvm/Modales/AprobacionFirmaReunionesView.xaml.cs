...
namespace SGPTmvvm.Modales
{
    ...
    /// </summary>
    public partial class AprobacionFirmaReunionesView : MetroWindow
    {
        ...
        public AprobacionFirmaReunionesView(FirmaReunionesMensajeModal Mensajito)
        {
            InitializeComponent();
            AprobacionFirmaReunionesViewModel vModel = new AprobacionFirmaReunionesViewModel(Mensajito);
