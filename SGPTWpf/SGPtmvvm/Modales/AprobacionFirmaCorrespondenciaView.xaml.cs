...
namespace SGPTmvvm.Modales
{
    ...
    /// </summary>
    public partial class AprobacionFirmaCorrespondenciaView : MetroWindow
    {
        ...
        public AprobacionFirmaCorrespondenciaView(FirmaCorrespondenciaMensajeModal Mensajito)
        {
            InitializeComponent();
            AprobacionFirmaCorrespondenciaViewModel vModel = new AprobacionFirmaCorrespondenciaViewModel(Mensajito);
