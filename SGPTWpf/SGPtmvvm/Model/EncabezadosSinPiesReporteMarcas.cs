...
{
    /// <summary>
    /// Esta clase sirve para poder enviar los encabezados y pies de pagina para generar los reportes de Marcas de auditoria. 
    /// </summary>
    public class EncabezadosSinPiesReporteMarcas
    {
        //Encabezado 
