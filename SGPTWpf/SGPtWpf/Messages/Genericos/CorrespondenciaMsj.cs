...
{
    class CorrespondenciaMsj : Messenger
    {
        ...
        public ObservableCollection<cedulacorrespondencia> listaDetalle { get; set; }

        public cedulacorrespondencia entidadDetalle { get; set; }
