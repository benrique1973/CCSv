        ...
        private static void IsFactoryStart(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue is String && String.IsNullOrEmpty((string)e.NewValue) == false)
            {
                ...
                else
                {
                    ...
                    crearVentana = new PrincipalAlterna();
                    crearVentana.DataContext = new PrincipalAlternaViewModel();
                    Application.Current.MainWindow = crearVentana;//Establece como  la ventana principal
                    crearVentana.Show();
                }
            }
            else
