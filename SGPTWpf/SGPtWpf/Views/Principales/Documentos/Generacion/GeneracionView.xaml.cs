...
namespace SGPTWpf.Views.Principales.Documentos.Generacion
{
    /// <summary>
    /// Lógica de interacción para GeneracionView.xaml
    /// </summary>
    public partial class GeneracionView : UserControl
    {
        private string token = "MenuDetalleDocumentosImpresion";
        public GeneracionView()
        {
            InitializeComponent();
            ...
            gridMenuLateral.MaxHeight = Height - 1;
            gridMenuLateral.Height = Height - 1;
            gridMenuLateral.MinHeight = Height * 0.5;

            dataGridMenu.MaxHeight = Height - 1;
            dataGridMenu.Height = Height - 1;
            dataGridMenu.MinHeight = Height * 0.5;
