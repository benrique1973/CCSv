...
{
    /// <summary>
    /// Lógica de interacción para SimboloCrudView.xaml
    /// </summary>
    public partial class SimboloCrudView : UserControl
    {
        public SimboloCrudView()
        {
            InitializeComponent();
            //Tamaño de pantalla
            ...
            datosOpcion.Width = Width * 0.30;
            datosOpcion.MinWidth = Width * 0.30;
            datosOpcion.MaxWidth = Width * 0.30;
