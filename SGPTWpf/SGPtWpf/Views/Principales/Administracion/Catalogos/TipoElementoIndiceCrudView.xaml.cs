...
{
    /// <summary>
    /// Lógica de interacción para TipoElementoIndiceCrudView.xaml
    /// </summary>
    public partial class TipoElementoIndiceCrudView : UserControl
    {
        public TipoElementoIndiceCrudView()
        {
            InitializeComponent();
            //Tamaño de pantalla
            ...
            correlativo.MinWidth = Width * 0.10;
            correlativo.MaxWidth = Width * 0.10;

            datosImagen.Width = Width * 0.30;
            datosImagen.MinWidth = Width * 0.30;
            datosImagen.MaxWidth = Width * 0.30;

            datos.Width = Width * 0.59;
            datos.MinWidth = Width * 0.59;
