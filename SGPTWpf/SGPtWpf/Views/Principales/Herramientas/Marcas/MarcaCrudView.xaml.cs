...
{
    /// <summary>
    /// Lógica de interacción para MarcaCrudView.xaml
    /// </summary>
    public partial class MarcaCrudView : UserControl
    {
        public MarcaCrudView()
        {
            InitializeComponent();
            ...
            correlativo.Width = dataGrid.Width * 0.10;
            correlativo.MinWidth = dataGrid.Width * 0.05;
            correlativo.MaxWidth = dataGrid.Width * 0.10;

            marcame.Width = dataGrid.Width * 0.25;
            marcame.MinWidth = dataGrid.Width * 0.10;
            marcame.MaxWidth = dataGrid.Width * 0.50;
