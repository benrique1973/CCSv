...
namespace SGPTWpf.SGPtWpf.Views.Principales.Encargos.Cedulas.Expediente
{
    /// <summary>
    /// Lógica de interacción para ExpedienteImpresionView.xaml
    /// </summary>
    public partial class ExpedienteImpresionView : MetroWindow
    {
        public ExpedienteImpresionView()
        {
            InitializeComponent();
            //Tamaño oficio
            this.Width = (8 * 96);//816
