...
{
    /// <summary>
    /// Lógica de interacción para CorrespondenciaImpresionView.xaml
    /// </summary>
    public partial class CorrespondenciaImpresionView : MetroWindow
    {
        public CorrespondenciaImpresionView()
        {
            InitializeComponent();
            //Tamaño oficio
            this.Width = (8 * 96);//816
