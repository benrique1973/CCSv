...
namespace SGPTWpf.SGPtWpf.Views.Principales.Encargos.Cedulas
{
    /// <summary>
    /// Lógica de interacción para CedulasView.xaml
    /// </summary>
    public partial class CedulasView : UserControl
    {
        private string token = "MenuCedulas";
        public CedulasView()
        {
            InitializeComponent();
