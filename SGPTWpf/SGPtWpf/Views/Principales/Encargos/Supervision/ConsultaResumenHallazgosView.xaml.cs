...
namespace SGPTWpf.SGPtWpf.Views.Principales.Encargos.Supervision
{
    /// <summary>
    /// Lógica de interacción para ConsultaResumenHallazgosView.xaml
    /// </summary>
    public partial class ConsultaResumenHallazgosView : UserControl
    {
        public ConsultaResumenHallazgosView()
        {
            InitializeComponent();
            //Tamaño de pantalla
