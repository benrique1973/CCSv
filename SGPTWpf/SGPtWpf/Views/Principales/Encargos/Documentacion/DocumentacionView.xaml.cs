...
{
    /// <summary>
    /// Lógica de interacción para DocumentacionView.xaml
    /// </summary>
    public partial class DocumentacionView : UserControl
    {
        private string token = "MenuDocumentacion";
        public DocumentacionView()
        {
            InitializeComponent();
