...
namespace SGPTWpf.SGPtWpf.Views.Principales.Encargos.Planificacion.Materialidad
{
    /// <summary>
    /// Lógica de interacción para MaterialidadView.xaml
    /// </summary>
    public partial class MaterialidadView : UserControl
    {
        public MaterialidadView()
        {
            InitializeComponent();
            //Tamaño de pantalla
