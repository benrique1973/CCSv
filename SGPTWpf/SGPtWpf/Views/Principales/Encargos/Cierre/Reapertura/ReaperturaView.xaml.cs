...
namespace SGPTWpf.SGPtWpf.Views.Principales.Encargos.Cierre.Reapertura
{
    /// <summary>
    /// Lógica de interacción para ReaperturaView.xaml
    /// </summary>
    public partial class ReaperturaView : UserControl
    {
        public ReaperturaView()
        {
            InitializeComponent();
            //Tamaño de pantalla
