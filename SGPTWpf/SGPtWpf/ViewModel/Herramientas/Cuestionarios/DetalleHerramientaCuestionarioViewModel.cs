...

{
    ...
    public  sealed class DetalleHerramientaCuestionarioViewModel : ViewModeloBase
    {
        ...
        public bool ventanasControl = false;//Controla si hay ventana abierta
        ...
        public DetalleHerramientaCuestionarioViewModel()
        {
            _comando = 0;// Se usa 2 para indicar sub-ventana
            _comando = 2;
            _opcionMenuCrud = 2;//Para indicar que es sub-ventana
            _opcionMenuPrincipal = 0; //1 para  programa 2, para cuestionario
            _fuenteLlamado = 1;//Se llama desde subventana
            _tokenRecepcionVista= "HerramientaCuestionarioCambioOrden";
            _origenLlamada ="";
            ...
            RegisterCommands();
            _tokenEnvioDetalle = "HCuestionarioDetalle";//Conexion con  Controller Preview
            HerramientasDetalleMain = new MainModel();
            ventanasControl = false;
            ...
            //Messenger.Default.Register<VentanaCrudDetalleHerramientaCuestionario>(this, (ventanaCrudDetalleHerramientaCuestionario) => ControlVentanaMensaje(ventanaCrudDetalleHerramientaCuestionario));
            //Suscripcion a mensajes de cuestionarios viewmodel
            Messenger.Default.Register<CuestionarioDetalleHerramientaMensaje>(this, (cuestionarioDetalleHerramientaMensaje) => ControlCuestionarioDetalleHerramientaMensaje(cuestionarioDetalleHerramientaMensaje));
            //Messenger.Default.Register<CrudVistaADetalleGuardarMensaje>(this, (crudVistaADetalleGuardarMensaje) => ControlCrudVistaADetalleGuardarMensaje(crudVistaADetalleGuardarMensaje));
        ...
        private void ControlCuestionarioDetalleHerramientaMensaje(CuestionarioDetalleHerramientaMensaje cuestionarioDetalleHerramientaMensaje)
        {
                opcionMenuPrincipal = cuestionarioDetalleHerramientaMensaje.opcionMenuPrincipal;//1 Para programa, 2 para cuestionario
                currentUsuario = cuestionarioDetalleHerramientaMensaje.usuarioValidado;
                currentHerramienta = cuestionarioDetalleHerramientaMensaje.herramientaModelo;
                opcionMenuCrud = cuestionarioDetalleHerramientaMensaje.opcionMenuCrud;
                ...
                enviarListaAVista();
                Messenger.Default.Unregister<CuestionarioDetalleHerramientaMensaje>(this);
       ...
       private void enviarListaAVista()
        {
            //Manda la referencia de la vista; Para cuestionarios
             //dlg.ShowMessageAsync(this, "Manda la lista detalleview model # " + cuentaMensajeDetalleCuestionario, "");
                HerramientasDetalleCuestionarioListaMensaje listaDetalleCuestionario = new HerramientasDetalleCuestionarioListaMensaje();
                listaDetalleCuestionario.listaElementos = Lista;
                Messenger.Default.Send(listaDetalleCuestionario);
        ...
        public void guardarLista()
        {
            try
            {
                foreach (DetalleHerramientasModelo item in Lista)
                {
                    if (item != null)
                    {
                        ...
                        {
                            //Guarda el orden si ha sido modificado
            ...
            {
                dlg.ShowMessageAsync(this, "Problema de actualizacion \n"+e, "");
            }
        }
        ...
        {
            //Se crea el mensaje
            DetalleHerramientasCuestionariosCrudMensaje elemento = new DetalleHerramientasCuestionariosCrudMensaje();
            ...
            enviarInhabilitarVentana(true);//Se lanza debe inhabilitar la ventana padre
        }
        ...
        public void enviarInhabilitarVentana(bool mensaje)
        {
            HabilitacionVentanaMensaje inHabilitar = new HabilitacionVentanaMensaje();
            inHabilitar.habilitarVentana = mensaje;
        ...
        private void ControlVentanaMensaje(VentanaCrudDetalleHerramientaCuestionario controlVentanaCrearMensaje)
        {
            //Para controlar la ventana abierta
            ventanasControl = controlVentanaCrearMensaje.inhabilitarVentanPadre;//Desbloquea ventana padre
            enviarInhabilitarVentana(controlVentanaCrearMensaje.inhabilitarVentanPadre);//Desbloquea antecesora
            //Habilitar la  ventana padre
            ...
            switch (comando)
            {
                ...
                case 3:
                    ...
                    break;
                case 4://Consulta de  vista del programa
                       //activarVentanaConsulta = true;
                    break;
                default:
                    break;
            ...
            accesibilidadWindow = true;
            Messenger.Default.Unregister<VentanaCrudDetalleHerramientaCuestionario>(this);
        ...
        public async void Nuevo()
        {
            if (!ventanasControl)
            {
                ...
                currentEntidad.horasPlanDh = 0;
                currentEntidad.descripcionByteaDh = null;
                currentEntidad.idtProcedimiento = 0;//No hay por defecto un  tipo de procedimiento
                currentEntidad.idHerramienta = currentHerramienta.idHerramienta;
                currentEntidad.ordenDh = ordenElementoLista();
                comando = 1;
                HerramientasDetalleMain.TypeName = "CuestionarioDetalleHerrramientaModeloCrearView";
                enviarElemento();
                ventanasControl = true;
            }
            else
            {
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                ...
                if (!ventanasControl)
                {
                    HerramientasDetalleMain.TypeName = "CuestionarioDetalleHerrramientaModeloEditarView";
                    comando = 2;
                    enviarElemento();
                    ventanasControl = true;
                }
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (!ventanasControl)
                {
                    ...
                    HerramientasDetalleMain.TypeName = "CuestionarioDetalleHerrramientaModeloConsultarView";
                    comando = 3;
                    enviarElemento();
                    ventanasControl = true;
                }
            ...
            if (!(currentEntidad == null))
            {
                if (!ventanasControl)
                {
                    ...
                    //if (HerramientasModelo.Delete(currentEntidad.id, true))
                    {
                        ...
                        //Lista.Remove(currentEntidad);//Se remueve de la  lista
                        ActualizarLista();
                        currentEntidad = new DetalleHerramientasModelo();
                        Mouse.OverrideCursor = null;
                        accesibilidadWindow = true;
        ...
        public bool CanCommand()
        {
            if (!(currentEntidad == null))
            {
                try
                {
                    return currentEntidad.idDh != 0 && !ventanasControl;
                }
                catch (Exception )
                {
                    return false;
        ...
        {
            NuevoCommand = new RelayCommand(Nuevo, canActivar);
        ...
        private bool canActivar()
        {
            return !ventanasControl;
        }
