...
{
    public sealed class DetalleHerramientaCuestionarioControllerViewModel : ViewModeloBase
    {
        ...
        public DetalleHerramientaCuestionarioControllerViewModel()
        {
            ...
            Messenger.Default.Register<DetalleHerramientasCuestionariosCrudMensaje>(this, (detalleHerramientasCuestionariosCrudMensaje) => ControlDetalleHerramientasCuestionariosCrudMensaje(detalleHerramientasCuestionariosCrudMensaje));
        ...
        private void ControlDetalleHerramientasCuestionariosCrudMensaje(DetalleHerramientasCuestionariosCrudMensaje detalleHerramientasCuestionariosCrudMensaje)
        {
            listaTipoProcedimiento = new ObservableCollection<TipoProcedimientoModelo>(TipoProcedimientoModelo.GetAllByIdTh(detalleHerramientasCuestionariosCrudMensaje.tiposHerramienta, true));
            tipoHerramientaMenu = detalleHerramientasCuestionariosCrudMensaje.tiposHerramienta;//1 Para programa 2 para cuestionario
            currentEntidad = detalleHerramientasCuestionariosCrudMensaje.detalleHerramientaElemento;
            currentUsuario = detalleHerramientasCuestionariosCrudMensaje.usuarioValidado;
            opcionMenu = detalleHerramientasCuestionariosCrudMensaje.comando;
            ...
            listaEntidadSeleccion =new ObservableCollection<DetalleHerramientasModelo>(detalleHerramientasCuestionariosCrudMensaje.listaElementos.Where(x=>x.idDh!= currentEntidad.idDh));
            }
            else
            { 
            listaEntidadSeleccion = detalleHerramientasCuestionariosCrudMensaje.listaElementos;
            }

            currentEntidad.listaEntidadSeleccion = listaEntidadSeleccion;//Para poder verificar que el procedimiento sea único
            ListaEntidad = detalleHerramientasCuestionariosCrudMensaje.listaElementos;
            ...
            if (!((currentEntidad.idVisitaDh == null) || (currentEntidad.idVisitaDh == 0)))
            {
            ...
            Messenger.Default.Unregister<DetalleHerramientasCuestionariosCrudMensaje>(this);
        ...
        {
            tipoProcedimientoPregunta = "Pregunta";
        ...
        public void enviarMensaje()
        {
            ...
            VentanaCrudDetalleHerramientaCuestionario cierre = new VentanaCrudDetalleHerramientaCuestionario();
            cierre.inhabilitarVentanPadre = false;
        ...
        public bool CanSave()
        {
            ...
            {
                evaluar = (Errors == 0) && ((SelectedTipoProcedimiento.id != 0));
                /*evaluar = !string.IsNullOrEmpty(currentEntidad.descripcionDh) &&
                            (currentEntidad.descripcionDh.Length <= maxDescripcion) &&
