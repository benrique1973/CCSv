...
namespace SGPTWpf.ViewModel.Herramientas.Cuestionarios
{
    public sealed class CuestionarioPresentacionViewModel : ViewModeloBase
    {
        ...
        public CuestionarioPresentacionViewModel()
        {
            ...
            _tokenRecepcionEncargos = "datosHCuestionario";
            _tokenRecepcionEncargosDetalle = "HCuestionarioDetalle";
            _tokenEnvioCierre = "CierreHCuestionario";
            _fuenteLlamado = "";
        ...
        private void ControlHerramientasModeloElementoMensajes(HModeloDatosMensajes herramientasModeloElementoMensajes)
        {
            ...
            {
                fuenteLlamado = "Main";
                tokenEnvioCierre = "CierrePrevioPrograma";
            ...
            else
            {
                ...
                tokenEnvioCierre = "CierrePrevioCuestionarioSub-ventana";
            ...
            //if (herramientasModeloElementoMensajes.opcionMenuPrincipal == 1)
            //{
            //    GestionAccesibilidad.finalizarComandoPrincipal();//Para inicial el proceso
            //}
            //else
            //{
            //    //Pendiente
