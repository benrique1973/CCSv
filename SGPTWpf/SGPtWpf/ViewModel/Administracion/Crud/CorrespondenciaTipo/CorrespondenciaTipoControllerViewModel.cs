...
namespace SGPTWpf.ViewModel.Crud.CorrespondenciaTipo
{
    ...
    /// </para>
    /// </summary>
    public sealed class CorrespondenciaTipoControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<CorrespondenciaTipoModelo> _ListaEntidad;

        public ObservableCollection<CorrespondenciaTipoModelo> ListaEntidad
        {
            get
            {
        ...
        public CorrespondenciaTipoControllerViewModel()
        {
            ...
            Messenger.Default.Register<CorrespondenciaTipoElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<CorrespondenciaTipoListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(CorrespondenciaTipoElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(CorrespondenciaTipoListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(CorrespondenciaTipoModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = CorrespondenciaTipoModelo.IdAsignar();
                        //if (!CorrespondenciaTipoModelo.FindClaseCuentaPK(currentEntidad.idct))
                        //{
                        if (CorrespondenciaTipoModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (CorrespondenciaTipoModelo.UpdateModelo(currentEntidad, true))
                                {
