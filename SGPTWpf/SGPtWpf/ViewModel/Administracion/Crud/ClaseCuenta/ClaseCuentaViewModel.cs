...
namespace SGPTWpf.ViewModel.Crud.ClaseCuenta
{
    ...
    /// </para>
    /// </summary>
    public sealed class ClaseCuentaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<ClaseCuentaModelo> _Lista;

        public ObservableCollection<ClaseCuentaModelo> Lista
        {
            get
            {
                return _Lista;
            ...
            #region descripcionccuentas de cuentas

            /// <summary>
            /// The <see cref="descripcionccuentas" /> property's name.
            /// </summary>
        ...
        #region Constructores
                ...
                public ClaseCuentaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clase de cuentas" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<ClaseCuentaModelo>(ClaseCuentaModelo.GetAll());
                    RegisterCommands();
        ...
        #region Envio mensajes
                    public void enviarMensaje()
                                ...
                                {
                                    //Se crea el mensaje
                                    ClaseCuentaElementoMensaje elemento = new ClaseCuentaElementoMensaje();
                                    if ((ventanas == 0))
                                    {
                                    ...
                                    Messenger.Default.Send<ClaseCuentaElementoMensaje>(elemento);
                                }
                                public void enviarLista()
                                {
                                    //Se crea el mensaje
                                    ClaseCuentaListaMensaje listaEnviada = new ClaseCuentaListaMensaje();
                                    if ((ventanas == 0))
                                    {
                                    ...
                                    Messenger.Default.Send<ClaseCuentaListaMensaje>(listaEnviada);
                                }
        #endregion
        ...
        #region Implementacion de comandos
            public async void Nuevo()
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "ClaseCuentaCrearView";
                    currentEntidad = new ClaseCuentaModelo();
                    enviarElemento();
                    enviarLista();
                    enviarMensaje();
                    comando = 1;
            ...
            public async void Editar()
            {
                if (!(currentEntidad == null))
                {
                    if (ventanas == 0)
                    {
                        ...
                        MainModel.TypeName = "ClaseCuentaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "ClaseCuentaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (ClaseCuentaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public bool CanSave()
        {
            return !(currentEntidad.id == 0) &&
                   !string.IsNullOrEmpty(currentEntidad.descripcionccuentas);
        }
            
        #region Verificaciones

                public void Actualizar(ObservableCollection<ClaseCuentaModelo> listaEntidad)
                {
                    Lista = listaEntidad;
                }
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<ClaseCuentaModelo>();
                }
            }
        }
