...
namespace SGPTWpf.ViewModel.Crud.TipoHerramienta
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoHerramientaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoHerramientaModelo> _Lista;

        public ObservableCollection<TipoHerramientaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcionth" /> property's name.
        /// </summary>
        ...
        public TipoHerramientaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clase de herramientas" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoHerramientaModelo>(TipoHerramientaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoHerramientaElementoMensaje elemento = new TipoHerramientaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoHerramientaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoHerramientaListaMensaje listaEnviada = new TipoHerramientaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoHerramientaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoHerramientaCrearView";
                currentEntidad = new TipoHerramientaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoHerramientaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoHerramientaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoHerramientaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoHerramientaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoHerramientaModelo>();
                }
            }
        }
