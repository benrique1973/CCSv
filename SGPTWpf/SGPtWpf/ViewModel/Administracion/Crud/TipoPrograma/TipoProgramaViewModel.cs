...
namespace SGPTWpf.ViewModel.Crud.TipoPrograma
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoProgramaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoProgramaModelo> _Lista;

        public ObservableCollection<TipoProgramaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        // Metodo adicionado
        public TipoProgramaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clase de programas" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoProgramaModelo>(TipoProgramaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoProgramaElementoMensaje elemento = new TipoProgramaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoProgramaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoProgramaListaMensaje listaEnviada = new TipoProgramaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoProgramaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoProgramaCrearView";
                currentEntidad = new TipoProgramaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoProgramaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoProgramaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoProgramaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoProgramaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoProgramaModelo>();
                }
            }
        }
