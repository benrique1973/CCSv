...
using SGPTWpf.Messages.EstructuraEstadoFinanciero;
...
namespace SGPTWpf.ViewModel.Crud.EstructuraEstadoFinanciero
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class EstructuraEstadoFinancieroViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<EstructuraEstadoFinancieroModelo> _Lista;

        public ObservableCollection<EstructuraEstadoFinancieroModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcioneef" /> property's name.
        /// </summary>
        ...
        private EstructuraEstadoFinancieroModelo _currentEntidad;

        public EstructuraEstadoFinancieroModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<EstructuraEstadoFinancieroModelo> SelectionChangedCommand { get; set; }
        ...
        public EstructuraEstadoFinancieroViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Estructuras de EF" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<EstructuraEstadoFinancieroModelo>(EstructuraEstadoFinancieroModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            EstructuraEstadoFinancieroElementoMensaje elemento = new EstructuraEstadoFinancieroElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<EstructuraEstadoFinancieroElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            EstructuraEstadoFinancieroListaMensaje listaEnviada = new EstructuraEstadoFinancieroListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<EstructuraEstadoFinancieroListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "EstructuraEstadoFinancieroCrearView";
                currentEntidad = new EstructuraEstadoFinancieroModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "EstructuraEstadoFinancieroEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "EstructuraEstadoFinancieroConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (EstructuraEstadoFinancieroModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<EstructuraEstadoFinancieroModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<EstructuraEstadoFinancieroModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<EstructuraEstadoFinancieroModelo>();
                }
            }
        }
