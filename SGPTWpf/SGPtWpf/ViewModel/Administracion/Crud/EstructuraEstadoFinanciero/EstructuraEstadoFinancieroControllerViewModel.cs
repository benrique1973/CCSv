...
namespace SGPTWpf.ViewModel.Crud.EstructuraEstadoFinanciero
{
    ...
    /// </para>
    /// </summary>
    public sealed class EstructuraEstadoFinancieroControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<EstructuraEstadoFinancieroModelo> _ListaEntidad;

        public ObservableCollection<EstructuraEstadoFinancieroModelo> ListaEntidad
        {
            get
            {
        ...
        public EstructuraEstadoFinancieroControllerViewModel()
        {
            ...
            Messenger.Default.Register<EstructuraEstadoFinancieroElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<EstructuraEstadoFinancieroListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(EstructuraEstadoFinancieroElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(EstructuraEstadoFinancieroListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(EstructuraEstadoFinancieroModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = EstructuraEstadoFinancieroModelo.IdAsignar();
                        //if (!EstructuraEstadoFinancieroModelo.FindClaseCuentaPK(currentEntidad.ideef))
                        //{
                        if (EstructuraEstadoFinancieroModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (EstructuraEstadoFinancieroModelo.UpdateModelo(currentEntidad, true))
                                {
