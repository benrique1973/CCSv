...
namespace SGPTWpf.ViewModel.Crud.TipoAuditoria
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoAuditoriaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoAuditoriaModelo> _Lista;

        public ObservableCollection<TipoAuditoriaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcionta" /> property's name.
        /// </summary>
        ...
        public TipoAuditoriaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clases de auditoría" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoAuditoriaModelo>(TipoAuditoriaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoAuditoriaElementoMensaje elemento = new TipoAuditoriaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoAuditoriaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoAuditoriaListaMensaje listaEnviada = new TipoAuditoriaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoAuditoriaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoAuditoriaCrearView";
                currentEntidad = new TipoAuditoriaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoAuditoriaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoAuditoriaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoAuditoriaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoAuditoriaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoAuditoriaModelo>();
                }
            }
        }
