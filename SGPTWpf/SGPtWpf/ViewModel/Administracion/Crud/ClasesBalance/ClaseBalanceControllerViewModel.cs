...
namespace SGPTWpf.ViewModel.Crud.ClaseBalance
{
    ...
    /// </para>
    /// </summary>
    public sealed class ClaseBalanceControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<ClaseBalanceModelo> _ListaEntidad;

        public ObservableCollection<ClaseBalanceModelo> ListaEntidad
        {
            get
            {
        ...
        public ClaseBalanceControllerViewModel()
        {
            ...
            Messenger.Default.Register<ClaseBalanceElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<ClaseBalanceListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(ClaseBalanceElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(ClaseBalanceListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(ClaseBalanceModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = ClaseBalanceModelo.IdAsignar();
                        //if (!ClaseBalanceModelo.FindClaseCuentaPK(currentEntidad.idcb))
                        //{
                        if (ClaseBalanceModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (ClaseBalanceModelo.UpdateModelo(currentEntidad, true))
                                {
