...
using SGPTWpf.Messages.ClaseBalance;
...
namespace SGPTWpf.ViewModel.Crud.ClaseBalance
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class ClaseBalanceViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<ClaseBalanceModelo> _Lista;

        public ObservableCollection<ClaseBalanceModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcioncb" /> property's name.
        /// </summary>
        ...
        private ClaseBalanceModelo _currentEntidad;

        public ClaseBalanceModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<ClaseBalanceModelo> SelectionChangedCommand { get; set; }
        ...
        public ClaseBalanceViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clase de balances" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<ClaseBalanceModelo>(ClaseBalanceModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            ClaseBalanceElementoMensaje elemento = new ClaseBalanceElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<ClaseBalanceElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            ClaseBalanceListaMensaje listaEnviada = new ClaseBalanceListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<ClaseBalanceListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "ClaseBalanceCrearView";
                currentEntidad = new ClaseBalanceModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "ClaseBalanceEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "ClaseBalanceConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (ClaseBalanceModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<ClaseBalanceModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ClaseBalanceModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<ClaseBalanceModelo>();
                }
            }
        }
