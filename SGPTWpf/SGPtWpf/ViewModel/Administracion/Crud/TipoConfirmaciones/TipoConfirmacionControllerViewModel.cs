...
namespace SGPTWpf.ViewModel.Crud.TipoConfirmacion
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoConfirmacionControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoConfirmacionModelo> _ListaEntidad;

        public ObservableCollection<TipoConfirmacionModelo> ListaEntidad
        {
            get
            {
        ...
        public TipoConfirmacionControllerViewModel()
        {
            ...
            Messenger.Default.Register<TipoConfirmacionElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<TipoConfirmacionListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(TipoConfirmacionElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(TipoConfirmacionListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(TipoConfirmacionModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = TipoConfirmacionModelo.IdAsignar();
                        //if (!TipoConfirmacionModelo.FindClaseCuentaPK(currentEntidad.idtconfirmacion))
                        //{
                        if (TipoConfirmacionModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (TipoConfirmacionModelo.UpdateModelo(currentEntidad, true))
                                {
