...
namespace SGPTWpf.ViewModel.Crud.Pais
{
    ...
    /// </para>
    /// </summary>
    public sealed class PaisControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<PaisModelo> _ListaEntidad;

        public ObservableCollection<PaisModelo> ListaEntidad
        {
            get
            {
        ...
        public PaisControllerViewModel()
        {
            ...
            Messenger.Default.Register<PaisElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<PaisListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(PaisElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(PaisListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(PaisModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = PaisModelo.IdAsignar();
                        //if (!PaisModelo.FindClaseCuentaPK(currentEntidad.idpais))
                        //{
                        if (PaisModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (PaisModelo.UpdateModelo(currentEntidad, true))
                                {
