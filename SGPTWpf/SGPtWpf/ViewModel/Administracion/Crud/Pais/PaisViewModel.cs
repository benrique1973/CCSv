...
namespace SGPTWpf.ViewModel.Crud.Pais
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class PaisViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<PaisModelo> _Lista;

        public ObservableCollection<PaisModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="nombrepais" /> property's name.
        /// </summary>
        ...
        private PaisModelo _currentEntidad;

        public PaisModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<PaisModelo> SelectionChangedCommand { get; set; }
        ...
        // Metodo adicionado
        public PaisViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Paises" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<PaisModelo>(PaisModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            PaisElementoMensaje elemento = new PaisElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<PaisElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            PaisListaMensaje listaEnviada = new PaisListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<PaisListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "PaisCrearView";
                currentEntidad = new PaisModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "PaisEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "PaisConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (PaisModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<PaisModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<PaisModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<PaisModelo>();
                }
            }
        }
