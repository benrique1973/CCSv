...
using SGPTWpf.Messages.Materialidad;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.Materialidad
{
    /// <summary>
    ...
    public sealed class MaterialidadViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<MaterialidadModelo> _Lista;

        public ObservableCollection<MaterialidadModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcionmaterialidad" /> property's name.
        /// </summary>
        ...
        private MaterialidadModelo _currentEntidad;

        public MaterialidadModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<MaterialidadModelo> SelectionChangedCommand { get; set; }
        ...
        // Metodo adicionado
        public MaterialidadViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Criterios de materialidad" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<MaterialidadModelo>(MaterialidadModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            MaterialidadElementoMensaje elemento = new MaterialidadElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<MaterialidadElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            MaterialidadListaMensaje listaEnviada = new MaterialidadListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<MaterialidadListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "MaterialidadCrearView";
                currentEntidad = new MaterialidadModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "MaterialidadEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "MaterialidadConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (MaterialidadModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<MaterialidadModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<MaterialidadModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<MaterialidadModelo>();
                }
            }
        }
