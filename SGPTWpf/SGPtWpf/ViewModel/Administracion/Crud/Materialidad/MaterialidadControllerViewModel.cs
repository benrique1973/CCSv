...
namespace SGPTWpf.ViewModel.Crud.Materialidad
{
    ...
    /// </para>
    /// </summary>
    public sealed class MaterialidadControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<MaterialidadModelo> _ListaEntidad;

        public ObservableCollection<MaterialidadModelo> ListaEntidad
        {
            get
            {
        ...
        public MaterialidadControllerViewModel()
        {
            ...
            Messenger.Default.Register<MaterialidadElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<MaterialidadListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(MaterialidadElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(MaterialidadListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(MaterialidadModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = MaterialidadModelo.IdAsignar();
                        //if (!MaterialidadModelo.FindClaseCuentaPK(currentEntidad.idmaterialidad))
                        //{
                        if (MaterialidadModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (MaterialidadModelo.UpdateModelo(currentEntidad, true))
                                {
