...
namespace SGPTWpf.ViewModel.Crud.ProcesoAuditoria
{
    ...
    /// </para>
    /// </summary>
    public sealed class ProcesoAuditoriaControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<ProcesoAuditoriaModelo> _ListaEntidad;

        public ObservableCollection<ProcesoAuditoriaModelo> ListaEntidad
        {
            get
            {
        ...
        public ProcesoAuditoriaControllerViewModel()
        {
            ...
            Messenger.Default.Register<ProcesoAuditoriaElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<ProcesoAuditoriaListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(ProcesoAuditoriaElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(ProcesoAuditoriaListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(ProcesoAuditoriaModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = ProcesoAuditoriaModelo.IdAsignar();
                        //if (!ProcesoAuditoriaModelo.FindClaseCuentaPK(currentEntidad.idpa))
                        //{
                        if (ProcesoAuditoriaModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (ProcesoAuditoriaModelo.UpdateModelo(currentEntidad, true))
                                {
