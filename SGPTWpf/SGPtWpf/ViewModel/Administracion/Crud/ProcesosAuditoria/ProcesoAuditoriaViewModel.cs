...
using SGPTWpf.Messages.ProcesosAuditoría;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.ProcesoAuditoria
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class ProcesoAuditoriaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<ProcesoAuditoriaModelo> _Lista;

        public ObservableCollection<ProcesoAuditoriaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcionpa" /> property's name.
        /// </summary>
        ...
        private ProcesoAuditoriaModelo _currentEntidad;

        public ProcesoAuditoriaModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<ProcesoAuditoriaModelo> SelectionChangedCommand { get; set; }
        ...
        // Metodo adicionado
        public ProcesoAuditoriaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Procesos de auditoría" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<ProcesoAuditoriaModelo>(ProcesoAuditoriaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            ProcesoAuditoriaElementoMensaje elemento = new ProcesoAuditoriaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<ProcesoAuditoriaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            ProcesoAuditoriaListaMensaje listaEnviada = new ProcesoAuditoriaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<ProcesoAuditoriaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "ProcesoAuditoriaCrearView";
                currentEntidad = new ProcesoAuditoriaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "ProcesoAuditoriaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "ProcesoAuditoriaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (ProcesoAuditoriaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<ProcesoAuditoriaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<ProcesoAuditoriaModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<ProcesoAuditoriaModelo>();
                }
            }
        }
