...
namespace SGPTWpf.ViewModel.Crud.Documento
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class DocumentoViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<DocumentoModelo> _Lista;

        public ObservableCollection<DocumentoModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripciondocumento" /> property's name.
        /// </summary>
        ...
        private DocumentoModelo _currentEntidad;

        public DocumentoModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<DocumentoModelo> SelectionChangedCommand { get; set; }
        ...
        public DocumentoViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionPadre = "Clase de documentos" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<DocumentoModelo>(DocumentoModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            DocumentoElementoMensaje elemento = new DocumentoElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<DocumentoElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            DocumentoListaMensaje listaEnviada = new DocumentoListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<DocumentoListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "DocumentoCrearView";
                currentEntidad = new DocumentoModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
                ...
                if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "DocumentoEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "DocumentoConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (DocumentoModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<DocumentoModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<DocumentoModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<DocumentoModelo>();
                }
            }
        }
