...
namespace SGPTWpf.ViewModel.Crud.Documento
{
    ...
    /// </para>
    /// </summary>
    public sealed class DocumentoControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<DocumentoModelo> _ListaEntidad;

        public ObservableCollection<DocumentoModelo> ListaEntidad
        {
            get
            {
        ...
        public DocumentoControllerViewModel()
        {
            ...
            Messenger.Default.Register<DocumentoElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<DocumentoListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(DocumentoElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(DocumentoListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(DocumentoModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = DocumentoModelo.IdAsignar();
                        //if (!DocumentoModelo.FindClaseCuentaPK(currentEntidad.iddocumento))
                        //{
                        if (DocumentoModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (DocumentoModelo.UpdateModelo(currentEntidad, true))
                                {
