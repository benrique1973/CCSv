...
namespace SGPTWpf.ViewModel.Crud.TipoElementoIndice
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoElementoIndiceViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoElementoIndiceModelo> _Lista;

        public ObservableCollection<TipoElementoIndiceModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripciontei" /> property's name.
        /// </summary>
        ...
        public TipoElementoIndiceViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Elementos de Indice" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoElementoIndiceModelo>(TipoElementoIndiceModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoElementoIndiceElementoMensaje elemento = new TipoElementoIndiceElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoElementoIndiceElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoElementoIndiceListaMensaje listaEnviada = new TipoElementoIndiceListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoElementoIndiceListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
                ...
                if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoElementoIndiceCrearView";
                currentEntidad = new TipoElementoIndiceModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
                ...
                if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoElementoIndiceEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoElementoIndiceConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
                ...
                if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoElementoIndiceModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoElementoIndiceModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoElementoIndiceModelo>();
                }
            }
        }
