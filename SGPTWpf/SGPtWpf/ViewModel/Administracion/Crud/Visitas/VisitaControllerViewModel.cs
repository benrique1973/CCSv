...
{
    public sealed class VisitaControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<VisitaModelo> _ListaEntidad;

        public ObservableCollection<VisitaModelo> ListaEntidad
        {
            get
            {
        ...
        public VisitaControllerViewModel()
        {
            ...
            Messenger.Default.Register<VisitaElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<VisitaListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(VisitaElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(VisitaListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(VisitaModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = VisitaModelo.IdAsignar();
                        //if (!VisitaModelo.FindClaseCuentaPK(currentEntidad.idvisita))
                        //{
                        if (VisitaModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (VisitaModelo.UpdateModelo(currentEntidad, true))
                                {
