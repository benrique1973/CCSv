...
using SGPTWpf.Messages.Visitas;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.Visita
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class VisitaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<VisitaModelo> _Lista;

        public ObservableCollection<VisitaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcionvisita" /> property's name.
        /// </summary>
        ...
        private VisitaModelo _currentEntidad;

        public VisitaModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<VisitaModelo> SelectionChangedCommand { get; set; }
        ...
        // Metodo adicionado
        public VisitaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clase de visitas" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<VisitaModelo>(VisitaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            VisitaElementoMensaje elemento = new VisitaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<VisitaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            VisitaListaMensaje listaEnviada = new VisitaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<VisitaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "VisitaCrearView";
                currentEntidad = new VisitaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "VisitaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "VisitaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (VisitaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<VisitaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<VisitaModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<VisitaModelo>();
                }
            }
        }
