...
namespace SGPTWpf.ViewModel.Crud.TipoPartida
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoPartidaControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoPartidaModelo> _ListaEntidad;

        public ObservableCollection<TipoPartidaModelo> ListaEntidad
        {
            get
            {
        ...
        public TipoPartidaControllerViewModel()
        {
            ...
            Messenger.Default.Register<TipoPartidaElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<TipoPartidaListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(TipoPartidaElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(TipoPartidaListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(TipoPartidaModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = TipoPartidaModelo.IdAsignar();
                        //if (!TipoPartidaModelo.FindClaseCuentaPK(currentEntidad.idtp))
                        //{
                        if (TipoPartidaModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (TipoPartidaModelo.UpdateModelo(currentEntidad, true))
                                {
