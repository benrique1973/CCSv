...
using SGPTWpf.Messages.TipoPartidas;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.TipoPartida
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class TipoPartidaViewModel : ViewModeloBase
    {
        ...
        public static int ventanas = 0;  private static bool activarVentanaConsulta = true;
        ...
        private ObservableCollection<TipoPartidaModelo> _Lista;

        public ObservableCollection<TipoPartidaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripciontp" /> property's name.
        /// </summary>
        ...
        private TipoPartidaModelo _currentEntidad;

        public TipoPartidaModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<TipoPartidaModelo> SelectionChangedCommand { get; set; }
        ...
        // Metodo adicionado
        public TipoPartidaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Tipos de partidas contables" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoPartidaModelo>(TipoPartidaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoPartidaElementoMensaje elemento = new TipoPartidaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoPartidaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoPartidaListaMensaje listaEnviada = new TipoPartidaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoPartidaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        private void ControlVentanaMensaje(VentanaViewMensaje controlVentanaCrearMensaje)
        {
            ...
            switch (comando)
            {
                ...
                case 2:
                    break;
                case 3:  activarVentanaConsulta = true;
                    break;
                default:
                    break;
            }
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoPartidaCrearView";
                currentEntidad = new TipoPartidaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoPartidaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoPartidaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoPartidaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoPartidaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<TipoPartidaModelo>(entidad =>
            {
        ...
        {
            //Se crea el mensaje
            SGPtWpf.Messages.Genericos.ComandoTerminado cursor = new ComandoTerminado();
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoPartidaModelo>();
                }
            }
        }
