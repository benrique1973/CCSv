...
namespace SGPTWpf.ViewModel.Crud.Rol
{
    ...
    /// </para>
    /// </summary>
    public sealed class RolViewModel : ViewModeloBase
    {
        ...
        /// <summary>
        /// The <see cref="nombrerol" /> property's name.
        /// </summary>
        ...
        // Metodo adicionado
        public RolViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Roles de usuario" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (RolModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<RolModelo>();
                }
            }
        }
