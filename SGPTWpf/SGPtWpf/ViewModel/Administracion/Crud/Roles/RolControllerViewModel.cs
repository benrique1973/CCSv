...
namespace SGPTWpf.ViewModel.Crud.Rol
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class RolControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<RolModelo> _ListaEntidad;

        public ObservableCollection<RolModelo> ListaEntidad
        {
            get
            {
        ...
        public RolControllerViewModel()
        {
            ...
            Messenger.Default.Register<RolElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<RolListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(RolElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(RolListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(RolModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = RolModelo.IdAsignar();
                        //if (!RolModelo.FindClaseCuentaPK(currentEntidad.idrol))
                        //{
                        if (RolModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (RolModelo.UpdateModelo(currentEntidad, true))
                                {
