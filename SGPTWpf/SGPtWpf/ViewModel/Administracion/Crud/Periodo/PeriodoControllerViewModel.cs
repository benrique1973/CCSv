...
namespace SGPTWpf.ViewModel.Crud.Periodo
{
    ...
    /// </para>
    /// </summary>
    public sealed class PeriodoControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<PeriodoModelo> _ListaEntidad;

        public ObservableCollection<PeriodoModelo> ListaEntidad
        {
            get
            {
        ...
        public PeriodoControllerViewModel()
        {
            ...
            Messenger.Default.Register<PeriodoElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<PeriodoListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(PeriodoElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(PeriodoListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(PeriodoModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = PeriodoModelo.IdAsignar();
                        //if (!PeriodoModelo.FindClaseCuentaPK(currentEntidad.idperiodos))
                        //{
                        if (PeriodoModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (PeriodoModelo.UpdateModelo(currentEntidad, true))
                                {
