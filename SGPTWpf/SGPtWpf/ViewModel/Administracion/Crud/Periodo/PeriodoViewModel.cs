...
using SGPTWpf.Messages.Periodos;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.Periodo
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class PeriodoViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<PeriodoModelo> _Lista;

        public ObservableCollection<PeriodoModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="periodicidadperiodos" /> property's name.
        /// </summary>
        ...
        private PeriodoModelo _currentEntidad;

        public PeriodoModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<PeriodoModelo> SelectionChangedCommand { get; set; }
        ...
        #region PeriodoModelo

        // Metodo adicionado
        public PeriodoViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Períodos" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<PeriodoModelo>(PeriodoModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            PeriodoElementoMensaje elemento = new PeriodoElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<PeriodoElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            PeriodoListaMensaje listaEnviada = new PeriodoListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<PeriodoListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "PeriodoCrearView";
                currentEntidad = new PeriodoModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "PeriodoEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "PeriodoConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (PeriodoModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<PeriodoModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<PeriodoModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<PeriodoModelo>();
                }
            }
        }
