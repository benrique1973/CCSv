...
namespace SGPTWpf.ViewModel.Crud.Moneda
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class MonedaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<MonedaModelo> _Lista;

        public ObservableCollection<MonedaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="idmoneda" /> property's name.
        /// </summary>
        ...
        #region Propiedades : simbolomoneda

        public const string simbolomonedaPropertyName = "simbolomoneda";

        private string _simbolomoneda = string.Empty;
        ...
        public string simbolomoneda
        {
            ...
            set
            {
                if (_simbolomoneda == value)
                {
                    return;
                }
                _simbolomoneda = value;
                RaisePropertyChanged(simbolomonedaPropertyName);
            }
        }
        ...
        private MonedaModelo _currentEntidad;

        public MonedaModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<MonedaModelo> SelectionChangedCommand { get; set; }
        ...
        public MonedaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Monedas y símbolos" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<MonedaModelo>(MonedaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            MonedaElementoMensaje moneda = new MonedaElementoMensaje();
            if ((ventanas == 0))
            {
                moneda.elementoMensaje = currentEntidad;
            }
            else
            {
                moneda.elementoMensaje = null;
            }
            Messenger.Default.Send<MonedaElementoMensaje>(moneda);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            MonedaListaMensaje listaEnviada = new MonedaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<MonedaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "MonedaCrearView";
                currentEntidad = new MonedaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "MonedaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "MonedaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (MonedaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<MonedaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<MonedaModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<MonedaModelo>();
                }
            }
        }
