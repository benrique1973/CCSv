...
{
    public sealed class MonedaControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<MonedaModelo> _ListaEntidad;

        public ObservableCollection<MonedaModelo> ListaEntidad
        {
            get
            {
   ...
   public MonedaControllerViewModel()
        {
            ...
            Messenger.Default.Register<MonedaElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<MonedaListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(MonedaElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(MonedaListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(MonedaModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = MonedaModelo.IdAsignar();
                        //if (!MonedaModelo.FindClaseCuentaPK(currentEntidad.idmoneda))
                        //{
                        if (MonedaModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (MonedaModelo.UpdateModelo(currentEntidad, true))
                                {
        ...
        public bool CanSave()
        {
            ...
            else
            {
                evaluar = !string.IsNullOrEmpty(currentEntidad.descripcion) &&
                           ...
                           !string.IsNullOrEmpty(currentEntidad.simbolomoneda)&&
                           (currentEntidad.simbolomoneda.Length <= maxSimbolo);
                return evaluar;
            }
        }
