...
using SGPTWpf.Messages.TiposCedula;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.TipoCedula
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class TipoCedulaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoCedulaModelo> _Lista;

        public ObservableCollection<TipoCedulaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        private TipoCedulaModelo _currentEntidad;

        public TipoCedulaModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<TipoCedulaModelo> SelectionChangedCommand { get; set; }
        ...
        public TipoCedulaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clases de cédula" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoCedulaModelo>(TipoCedulaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoCedulaElementoMensaje elemento = new TipoCedulaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoCedulaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoCedulaListaMensaje listaEnviada = new TipoCedulaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoCedulaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoCedulaCrearView";
                currentEntidad = new TipoCedulaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoCedulaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoCedulaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoCedulaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoCedulaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<TipoCedulaModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoCedulaModelo>();
                }
            }
        }
