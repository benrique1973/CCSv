...
namespace SGPTWpf.ViewModel.Crud.TipoCedula
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoCedulaControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoCedulaModelo> _ListaEntidad;

        public ObservableCollection<TipoCedulaModelo> ListaEntidad
        {
            get
            {
        ...
        public TipoCedulaControllerViewModel()
        {
            ...
            Messenger.Default.Register<TipoCedulaElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<TipoCedulaListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(TipoCedulaElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(TipoCedulaListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(TipoCedulaModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = TipoCedulaModelo.IdAsignar();
                        //if (!TipoCedulaModelo.FindClaseCuentaPK(currentEntidad.idtc))
                        //{
                        if (TipoCedulaModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (TipoCedulaModelo.UpdateModelo(currentEntidad, true))
                                {
