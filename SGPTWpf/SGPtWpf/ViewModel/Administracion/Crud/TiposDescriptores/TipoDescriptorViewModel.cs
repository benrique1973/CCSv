...
using SGPTWpf.Messages.TiposDescriptores;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.TiposDescriptor
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class TipoDescriptorViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoDescriptorModelo> _Lista;

        public ObservableCollection<TipoDescriptorModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="tipotd" /> property's name.
        /// </summary>
        ...
        private TipoDescriptorModelo _currentEntidad;

        public TipoDescriptorModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<TipoDescriptorModelo> SelectionChangedCommand { get; set; }
        ...
        // Metodo adicionado
        public TipoDescriptorViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clase de simbolos" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoDescriptorModelo>(TipoDescriptorModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TiposDescriptorElementoMensaje elemento = new TiposDescriptorElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TiposDescriptorElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TiposDescriptorListaMensaje listaEnviada = new TiposDescriptorListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TiposDescriptorListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoDescriptorCrearView";
                currentEntidad = new TipoDescriptorModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoDescriptorEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoDescriptorConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoDescriptorModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoDescriptorModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<TipoDescriptorModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoDescriptorModelo>();
                }
            }
        }
