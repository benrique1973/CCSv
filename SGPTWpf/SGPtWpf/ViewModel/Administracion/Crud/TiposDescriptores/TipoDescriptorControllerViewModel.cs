...
namespace SGPTWpf.ViewModel.Crud.TiposDescriptor
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoDescriptorControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoDescriptorModelo> _ListaEntidad;

        public ObservableCollection<TipoDescriptorModelo> ListaEntidad
        {
            get
            {
        ...
        public TipoDescriptorControllerViewModel()
        {
            ...
            Messenger.Default.Register<TiposDescriptorElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<TiposDescriptorListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(TiposDescriptorElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(TiposDescriptorListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(TipoDescriptorModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = TipoDescriptorModelo.IdAsignar();
                        //if (!TipoDescriptorModelo.FindClaseCuentaPK(currentEntidad.idtd))
                        //{
                        if (TipoDescriptorModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (TipoDescriptorModelo.UpdateModelo(currentEntidad, true))
                                {
