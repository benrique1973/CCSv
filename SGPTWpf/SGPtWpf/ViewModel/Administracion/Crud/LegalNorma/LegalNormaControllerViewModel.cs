...
using System;
using SGPTWpf.Messages.Administracion.LegalNorma;
...
namespace SGPTWpf.ViewModel.Crud.LegalNorma
{
    ...
    /// </para>
    /// </summary>
    public sealed class LegalNormaControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<LegalNormaModelo> _ListaEntidad;

        public ObservableCollection<LegalNormaModelo> ListaEntidad
        {
            get
            {
        ...
        public LegalNormaControllerViewModel()
        {
            ...
            Messenger.Default.Register<LegalNormaElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<LegalNormaListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
        ...
        private void ControlElementoMensaje(LegalNormaElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; 
        }
        private void ControlListaMensaje(LegalNormaListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(LegalNormaModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = LegalNormaModelo.IdAsignar();
                        //if (!LegalNormaModelo.FindClaseCuentaPK(currentEntidad.idln))
                        //{
                        if (LegalNormaModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (LegalNormaModelo.UpdateModelo(currentEntidad, true))
                                {
