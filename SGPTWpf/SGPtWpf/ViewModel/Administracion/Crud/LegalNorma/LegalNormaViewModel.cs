...
using SGPTWpf.Messages.LegalNorma;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.LegalNorma
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class LegalNormaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<LegalNormaModelo> _Lista;

        public ObservableCollection<LegalNormaModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripcionln" /> property's name.
        /// </summary>
        ...
        private LegalNormaModelo _currentEntidad;

        public LegalNormaModelo currentEntidad
        {
            get
            {
        ...
        // Metodo adicionado
        public LegalNormaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Estructuras de normas" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<LegalNormaModelo>(LegalNormaModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            LegalNormaElementoMensaje elemento = new LegalNormaElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<LegalNormaElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            LegalNormaListaMensaje listaEnviada = new LegalNormaListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<LegalNormaListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "LegalNormaCrearView";
                currentEntidad = new LegalNormaModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "LegalNormaEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "LegalNormaConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (LegalNormaModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<LegalNormaModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<LegalNormaModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<LegalNormaModelo>();
                }
            }
        }
