...
namespace SGPTWpf.ViewModel.Crud.TipoRespuestaCuestionario
{
    ...
    /// </para>
    /// </summary>
    public sealed class TipoRespuestaCuestionarioControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoRespuestaCuestionarioModelo> _ListaEntidad;

        public ObservableCollection<TipoRespuestaCuestionarioModelo> ListaEntidad
        {
            get
            {
        ...
        public TipoRespuestaCuestionarioControllerViewModel()
        {
            ...
            Messenger.Default.Register<TipoRespuestaCuestionarioElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<TipoRespuestaCuestionarioListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(TipoRespuestaCuestionarioElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje; ;
        }

        private void ControlListaMensaje(TipoRespuestaCuestionarioListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(TipoRespuestaCuestionarioModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = TipoRespuestaCuestionarioModelo.IdAsignar();
                        //if (!TipoRespuestaCuestionarioModelo.FindClaseCuentaPK(currentEntidad.idtrc))
                        //{
                        if (TipoRespuestaCuestionarioModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (TipoRespuestaCuestionarioModelo.UpdateModelo(currentEntidad, true))
                                {
