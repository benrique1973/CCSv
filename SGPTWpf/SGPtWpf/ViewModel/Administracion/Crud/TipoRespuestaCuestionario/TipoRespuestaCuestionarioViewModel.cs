...
using SGPTWpf.Messages.TipoRespuestaCuestionario;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.TipoRespuestaCuestionario
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class TipoRespuestaCuestionarioViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoRespuestaCuestionarioModelo> _Lista;

        public ObservableCollection<TipoRespuestaCuestionarioModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripciontrc" /> property's name.
        /// </summary>
        ...
        private TipoRespuestaCuestionarioModelo _currentEntidad;

        public TipoRespuestaCuestionarioModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<TipoRespuestaCuestionarioModelo> SelectionChangedCommand { get; set; }
        ...
        // Metodo adicionado
        public TipoRespuestaCuestionarioViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Respuesta de cuestionarios" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoRespuestaCuestionarioModelo>(TipoRespuestaCuestionarioModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoRespuestaCuestionarioElementoMensaje elemento = new TipoRespuestaCuestionarioElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoRespuestaCuestionarioElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoRespuestaCuestionarioListaMensaje listaEnviada = new TipoRespuestaCuestionarioListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoRespuestaCuestionarioListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoRespuestaCuestionarioCrearView";
                currentEntidad = new TipoRespuestaCuestionarioModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoRespuestaCuestionarioEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoRespuestaCuestionarioConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoRespuestaCuestionarioModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoRespuestaCuestionarioModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<TipoRespuestaCuestionarioModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoRespuestaCuestionarioModelo>();
                }
            }
        }
