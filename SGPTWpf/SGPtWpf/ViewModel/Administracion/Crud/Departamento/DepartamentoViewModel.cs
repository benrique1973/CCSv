...
{
    public sealed class DepartamentoViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<DepartamentoModelo> _Lista;

        public ObservableCollection<DepartamentoModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        public DepartamentoViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Departamentos por país" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<DepartamentoModelo>(DepartamentoModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            DepartamentoElementoMensaje elemento = new DepartamentoElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<DepartamentoElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            DepartamentoListaMensaje listaEnviada = new DepartamentoListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<DepartamentoListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "DepartamentoCrearView";
                currentEntidad = new DepartamentoModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "DepartamentoEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "DepartamentoConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (DepartamentoModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<DepartamentoModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<DepartamentoModelo>();
                }
            }
        }
