...
using SGPTWpf.Messages.TiposTelefonos;
using SGPTWpf.Model;
...
namespace SGPTWpf.ViewModel.Crud.TipoTelefono
{
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public sealed class TipoTelefonoViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoTelefonoModelo> _Lista;

        public ObservableCollection<TipoTelefonoModelo> Lista
        {
            get
            {
                return _Lista;
        ...
        /// <summary>
        /// The <see cref="descripciontt" /> property's name.
        /// </summary>
        ...
        private TipoTelefonoModelo _currentEntidad;

        public TipoTelefonoModelo currentEntidad
        {
            get
            {
        ...
        public RelayCommand<TipoTelefonoModelo> SelectionChangedCommand { get; set; }
        ...
        public TipoTelefonoViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _tokenRecepcionHijo = "";
            _tokenRecepcionPadre = "Clase de teléfonos" + "CatalogosViewModel";//Permite captar los mensajes del  menú planificacion
            ...
            Lista = new ObservableCollection<TipoTelefonoModelo>(TipoTelefonoModelo.GetAll());
            RegisterCommands();
        ...
        {
            //Se crea el mensaje
            TipoTelefonoElementoMensaje elemento = new TipoTelefonoElementoMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoTelefonoElementoMensaje>(elemento);
        }
        public void enviarLista()
        {
            //Se crea el mensaje
            TipoTelefonoListaMensaje listaEnviada = new TipoTelefonoListaMensaje();
            if ((ventanas == 0))
            {
            ...
            Messenger.Default.Send<TipoTelefonoListaMensaje>(listaEnviada);
        }
        #endregion
        ...
        public async void Nuevo()
        {
            if (ventanas == 0)
            {
                ...
                MainModel.TypeName = "TipoTelefonoCrearView";
                currentEntidad = new TipoTelefonoModelo();
                enviarElemento();
                enviarLista();
                enviarMensaje();
                comando = 1;
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    MainModel.TypeName = "TipoTelefonoEditarView";
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                if (activarVentanaConsulta)
                {
                    if (ventanas == 0)
                    {
                        MainModel.TypeName = "TipoTelefonoConsultarView";
                        enviarElemento();
                        enviarMensaje();
                        comando = 3;
        ...
        public async void Borrar()
        {
            if (!(currentEntidad == null))
            {
                if (ventanas == 0)
                {
                    ...
                    if (TipoTelefonoModelo.DeleteBorradoLogico(currentEntidad.id, true))
                    {
        ...
        public void Actualizar(ObservableCollection<TipoTelefonoModelo> listaEntidad)
        {
            Lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<TipoTelefonoModelo>(entidad =>
            {
        ...
        private void actualizarLista()
        {
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    Lista = new ObservableCollection<TipoTelefonoModelo>();
                }
            }
        }
