...
namespace SGPTWpf.ViewModel.Crud.TipoTelefono
{
    ...
    /// </para>
    /// </summary>
    public sealed  class TipoTelefonoControllerViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<TipoTelefonoModelo> _ListaEntidad;

        public ObservableCollection<TipoTelefonoModelo> ListaEntidad
        {
            get
            {
        ...
        public TipoTelefonoControllerViewModel()
        {
            ...
            Messenger.Default.Register<TipoTelefonoElementoMensaje>(this, (controlElementoMensaje) => ControlElementoMensaje(controlElementoMensaje));
            Messenger.Default.Register<TipoTelefonoListaMensaje>(this, (controlListaMensaje) => ControlListaMensaje(controlListaMensaje));
            RegisterCommands();
        ...
        private void ControlElementoMensaje(TipoTelefonoElementoMensaje controlElementoMensaje)
        {
            currentEntidad = controlElementoMensaje.elementoMensaje;
        }

        private void ControlListaMensaje(TipoTelefonoListaMensaje controlListaMensaje)
        {
        ...
        {
            if (!(TipoTelefonoModelo.FindTexto(currentEntidad.descripcion)))
        {
            if (!string.IsNullOrEmpty(currentEntidad.descripcion))
            {
                ...
                if (currentEntidad.descripcion.Length <= maxDescripcion)
                {
                    ...
                    {
                        //currentEntidad.id = TipoTelefonoModelo.IdAsignar();
                        //if (!TipoTelefonoModelo.FindClaseCuentaPK(currentEntidad.idtt))
                        //{
                        if (TipoTelefonoModelo.Insert(currentEntidad, true))
                        {
                    ...
                    else
                    {
                        ...
                        {
                            {
                                if (TipoTelefonoModelo.UpdateModelo(currentEntidad, true))
                                {
