...
namespace SGPTWpf.SGPtWpf.ViewModel.Documentos.Consulta
{
    public sealed class IndicePortadaViewModel : ViewModeloBase
    {
        ...
        {
            //dlg.ShowMessageAsync(this, "Proceso de impresion xxx", "En proceso");
            ...
            if (resultk == MessageDialogResult.Affirmative)
            {
                ...
                EncabezadosPiesReportesPortadasCarpetas ep = new EncabezadosPiesReportesPortadasCarpetas();
                ...
                msj.TipoReporteAGenerar = TipoReporteAGenerar.PortadaCarpeta;

                msj.EncabezadosPiesReportesPortadasCarpetas = ep;

                ReportesAImpresionMainModel.TypeName = "ReportePortadaCarpeta";
