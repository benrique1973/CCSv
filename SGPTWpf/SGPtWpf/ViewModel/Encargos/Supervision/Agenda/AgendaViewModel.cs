...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Supervision.Agenda
{
    ...
    public sealed class AgendaViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<CedulaAgendaModelo> _SelectedItems;

        public ObservableCollection<CedulaAgendaModelo> SelectedItems
        {
            get
            {
        ...
        private ObservableCollection<CedulaAgendaModelo> _lista;

        public ObservableCollection<CedulaAgendaModelo> lista
        {
            get
            {
                return _lista;
        ...
        private CedulaAgendaModelo _currentEntidadDetalle;

        public CedulaAgendaModelo currentEntidadDetalle
        {
            get
            {
        ...
        public RelayCommand<CedulaAgendaModelo> SelectionChangedCommand { get; set; }
        ...
        public AgendaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                case "SupervisionAgenda":
                    _menuElegido = "Supervision";
                    _nombreopcionor = "Asuntos pendientes";
                    fuenteLlamado = 1;
                    _idtc = 18;//
                    //18;"Agenda";"A";TRUE
                    #region tokens

                    _tokenRecepcionPadre = "Asuntos pendientes" + "Supervision";//Permite captar los mensajes del  menú planificacion, corresponde a Indices

                    _tokenEnvioDatosAHijo = "datosEncargoCedulaAgenda";//Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulaAgendaController";

                    #endregion

                    RegisterCommands();
                    _tablaDetalle = "Agenda";
                    #region  menu
                ...
                case "cedulasAgenda":
                    ...
                    _nombreopcionor = "Agenda";
                    fuenteLlamado = 1;
                    _idtc = 18;//
                    //18;"Agenda";"A";TRUE
                    #region tokens

                    _tokenRecepcionPadre = "Agenda" + "Cédulas";//Permite captar los mensajes del  menú planificacion, corresponde a Indices
            ...
            currentEntidadDetalle = new CedulaAgendaModelo();
            _comando = 0;
            dlg = new DialogCoordinator();
            lista = new ObservableCollection<CedulaAgendaModelo>();//Lista vacia no se conoce el encargo y el cliente
        ...
        private async void ControlRecepcionDatos(EncargosDatosMsj msj)
        {
            ...
            currentEntidad = CedulaModelo.FindMaestro(currentEncargo.idencargo, idtc, "Cédula de tareas");
            switch (currentEntidad.idcedula)
            {
                ...
                case 0:
                    ...
                    currentEntidad.titulocedula = "Cédula de tareas";
        ...
        private void actualizarLista()
        {
            ...
            try
            {
                ...
                { 
                    case  "SupervisionAgenda":
                    lista = CedulaAgendaModelo.GetAllEdicion(currentEncargo, currentEntidad.idcedula);
                    break;
                    case "cedulasAgenda":
                     lista = CedulaAgendaModelo.GetAllEdicionByUsuario(currentEncargo, currentEntidad.idcedula,usuarioModelo.idUsuario);
                    break;
                }
            ...
            catch (Exception e)
            {
                if (e.Source != null)
                {
                    ...
                    lista = new ObservableCollection<CedulaAgendaModelo>();
        ...
        public void Nuevo()
        {
            ...
            currentEntidadDetalle = new CedulaAgendaModelo(currentEntidad, currentEncargo, usuarioModelo);
            currentEntidadDetalle.idusuarioasigna = usuarioModelo.idUsuario;
            currentEntidadDetalle.usuariocerro = usuarioModelo.inicialesusuario;
            ECMainModel.TypeName = "CedulaAgendaCrearview";
            #endregion
        ...
        public async void Editar()
        {
            ...
            {
                switch (currentEntidadDetalle.estadoprocesoagenda)
                { 
                case "Asignada":
                        iniciarComando();
                        comando = 2;
                        if (currentEntidadDetalle.idusuarioasigna == usuarioModelo.idUsuario)
                        {
                            currentEntidadDetalle.usuarioModelo = usuarioModelo;
                            //currentEntidadDetalle.fechacreadoagenda = MetodosModelo.homologacionFecha();
                            ECMainModel.TypeName = "CedulaAgendaEditarView";
                            enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
                        }
                        else
                        {
                            await mensajeAutoCerrado("La tarea solo puede ser editada por el creador", "Solicite al  creador el modificarla", 2);
                            finComando();
                        }
                        break;
                case "Respondida":
                        iniciarComando();
                        if (currentEntidadDetalle.idusuarioresponable == usuarioModelo.idUsuario)
                        {
                            comando = 2;
                            if (!string.IsNullOrEmpty(currentEntidadDetalle.comentariorespuestaagenda))
                            {
                                currentEntidadDetalle.usuarioModelo = usuarioModelo;
                                //currentEntidadDetalle.fechacreadoagenda = MetodosModelo.homologacionFecha();
                                ECMainModel.TypeName = "CedulaAgendaEditarView";
                            ...
                            {
                                await mensajeAutoCerrado("No ha respondido la tarea", "No hay nada que editar", 2);
                                finComando();
                            }
                        }
                        else
                        {
                            await mensajeAutoCerrado("Solo el usuario asignado", "puede modificar la respuesta", 2);
                            finComando();
                        }
        ...
        public async void Consultar()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                currentEntidadDetalle.usuarioModelo = usuarioModelo;
                currentEntidadDetalle.fechacreadoagenda = MetodosModelo.homologacionFecha();
                ECMainModel.TypeName = "CedulaAgendaConsultarView";
                enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                if (result == MessageDialogResult.Affirmative)
                {
                    ...
                    if (lista.Where(x => x.IsSelected).Count() == 1)
                    {
                        ...
                        switch (CedulaAgendaModelo.evaluarBorrar(currentEntidadDetalle))
                        {
                            case -1:
                                finComando();
                            ...
                            case 1:
                                ...
                                switch (CedulaAgendaModelo.Delete(currentEntidadDetalle))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                    ...
                    else
                    {
                        ...
                        ObservableCollection<CedulaAgendaModelo> temporal = new ObservableCollection<CedulaAgendaModelo>();
                        foreach (CedulaAgendaModelo item in lista)
                        {
                            if (item.IsSelected)
                            {
                                switch (CedulaAgendaModelo.evaluarBorrar(currentEntidadDetalle))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error al consultar  " + item.encabezadoagenda, "intentelo en otro momento");
                                        iniciarComando();
                                        //Hay error en el procedimiento
                                        break;
                                    case 0:
                                    ...
                                    default:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "No puede eliminarse " + item.encabezadoagenda, "porque ya se respondió la tarea");
                                        iniciarComando();
                                        break;
                                }
                            }
                        ...
                        if (temporal.Count > 0)
                        {
                            ...
                            switch (CedulaAgendaModelo.Delete(temporal))
                            {
                                case -1:
                                    finComando();
                                    await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                ...
                if (result == MessageDialogResult.Affirmative)
                {
                    ...
                    if (lista.Where(x => x.IsSelected).Count() == 1)
                    {
                        ...
                        switch (CedulaAgendaModelo.evaluarBorrar(currentEntidadDetalle))
                        {
                            ...
                            case 1:
                                //Puede borrarse por completo
                                switch (CedulaAgendaModelo.DeleteLogico(currentEntidadDetalle))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                    ...
                    else
                    {
                        ...
                        foreach (CedulaAgendaModelo item in lista)
                        {
                            if (item.IsSelected)
                            {
                                ...
                                //switch (IndiceModelo.EvaluarBorrar(currentEntidadDetalle.id))
                                {
                                    ...
                                    default:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "No puede eliminarse " + item.encabezadoagenda, "porque hay papeles referenciados");
                                        iniciarComando();
                                        break;
                                }
                            }
                        ...
                        {
                            //caso de muchos registros
                            switch (CedulaAgendaModelo.DeleteBorradoLogico(temporal))
                            {
                                case -1:
                                    finComando();
                                    await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
        ...
        public void Actualizar(ObservableCollection<CedulaAgendaModelo> listaEntidad)
        {
            lista = listaEntidad;
        }
        ...
        public bool CanCommand()
        {
            if (!(currentEntidadDetalle == null))
            {
                try
                {
                    return currentEntidadDetalle.idagenda != 0;
                }
                catch (Exception)
                {
                    return false;
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<CedulaAgendaModelo>(entidad =>
            {
        ...
        private bool CanResponder()
        {
            ...
            {
                return ((currentEntidad.usuariocerro == null || currentEntidad.usuariocerro == string.Empty)
                    && (currentEntidadDetalle.estadoprocesoagenda!= "Respondida")
                    && (currentEntidadDetalle.estadoprocesoagenda != "Terminada"));
            }
        }
        ...
        public async void aprobarTarea()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                MessageDialogResult result = await dlg.ShowMessageAsync(this, "Aprobar implica dar por valido, el trabajo reportado", "¿Desea aprobar el trabajo?", MessageDialogStyle.AffirmativeAndNegative, mySettings);

                if (result == MessageDialogResult.Affirmative)
                {
                    iniciarComando();
                    //Repite el  ciclo para evitar errores
                    if (currentEntidadDetalle.idusuarioasigna == usuarioModelo.idUsuario || usuarioModelo.idRolPadre==2)//idrol=2 es de  Socio
                    {
                        //Es el usuario que creo la actividad o es  un usuario con perfil de socio
                        switch (CedulaAgendaModelo.AprobatTarea(currentEntidadDetalle, usuarioModelo))
                        //switch (IndiceModelo.EvaluarBorrar(currentEntidadDetalle.id))
                        {
                            case -1:
                    ...
                    {
                        await mensajeAutoCerrado("Solo el usuario que creó la actividad puede darla por terminada", "O un usuario con perfil de socio", 1);
                        finComando();
                    }
                }
                else
        ...
        public async void Responder()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                if (currentEntidadDetalle.estadoprocesoagenda != "Terminada")
                {
                    iniciarComando();
                    comando = 14;
                    if (currentEntidadDetalle.idusuarioresponable == usuarioModelo.idUsuario)
                    {
                        ...
                        {
                            await mensajeAutoCerrado("Ya esta respondida la  tarea", "para modificarla presione editar", 2);
                            finComando();
                        }
                    }
                    else
                    {
                        await mensajeAutoCerrado("Solo el usuario que asignado a la tarea", "La puede responder", 2);
                        finComando();
                    }
                }
                else
                {
                    await mensajeAutoCerrado("La tarea ya fue cerrada", "No puede responderla", 2);
                }
            }
            else
            {
        ...
        private bool CanBorrar()
        {
            ...
            {
                return ((currentEntidad.usuariocerro == null || currentEntidad.usuariocerro == string.Empty)
                    &&((currentEntidadDetalle.estadoprocesoagenda== "Asignada")|| (currentEntidadDetalle.estadoprocesoagenda == "No identificada")));
            }
        }
        ...
        private bool CanAprobar()
        {
            ...
            else
            {
                return (((!string.IsNullOrEmpty(currentEntidad.usuariocerro)))
                    ...
                    && lista.Where(x => x.estadoprocesoagenda == "Terminada").Count() == lista.Count);
            }
        }
        ...
        private async void aprobarPapel()
        {
            if (!(currentEntidad == null))
            {
                ...
                ECMainModel.TypeName = "CedulaAgendaAprobarView";
                #region Configuracion
                currentEntidad.usuarioModelo = usuarioModelo;
                #endregion
                enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaAgendaSupervisarView";
                    #region Configuracion
                    currentEntidad.usuarioModelo = usuarioModelo;
                    #endregion
                    enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidad == null))
            {
                ...
                if (estadoDocumento == 1) //Hay cero procedimientos diferentes a iniciados
                {
                    if (currentEntidad.referenciacedula != string.Empty)
                    {
                        ...
                        ECMainModel.TypeName = "CedulaAgendaCerrarView";
                        #region Configuracion
                        currentEntidad.usuarioModelo = usuarioModelo;
                        #endregion
                        enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void vistaPapel()
        {
            ...
            //currentEntidadDetalle.usuarioModelo = usuarioModelo;
            //currentEntidadDetalle.fechacreadoagenda = MetodosModelo.homologacionFecha();
            ECMainModel.TypeName = "CedulaAgendaVerView";
            enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
