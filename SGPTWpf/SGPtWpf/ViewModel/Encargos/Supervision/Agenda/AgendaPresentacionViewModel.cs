...
{
    public sealed class AgendaPresentacionViewModel : ViewModeloBase
    {
        ...
        public AgendaPresentacionViewModel()
        {

        }

        public AgendaPresentacionViewModel(string origen)
        {
            #region configuracion general
            enviarMensajeInhabilitar();
            _currentEntidad = new CedulaModelo();
            _currentEntidadDetalle = new CedulaAgendaModelo();
            _lista = new ObservableCollection<CedulaAgendaModelo>();
            ...
            switch (origen)
            {
                case "CedulaAgenda":
                    ...
                    _tokenEnvioCierre = "datosEncargoCedulaAgendaController";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Agenda";
                    break;
                case "IndiceCedulaAgenda":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
                    _tokenEnvioCierre = "datosControllerDetalleIndices";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Agenda";
                    break;
                case "ImprimirIndiceCedulaAgenda":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
            ...
            Messenger.Default.Register<AgendaMsj>(this, tokenRecepcion, (ElementoMsj) => ControlDetalleHerramientoCrudMensaje(ElementoMsj));
        ...
        private void ControlDetalleHerramientoCrudMensaje(AgendaMsj ElementoMsj)
        {
            //Procesos normal
            ...
            llenadoDatos();
            //Desuscribir mensaje
            Messenger.Default.Unregister<AgendaMsj>(this, tokenRecepcion);//Proviene de pantalla principal
