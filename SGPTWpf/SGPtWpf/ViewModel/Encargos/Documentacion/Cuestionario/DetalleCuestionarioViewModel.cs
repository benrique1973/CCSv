...

{
    ...
    public sealed class DetalleCuestionarioViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<detallecuestionario> _listaDetalleCapaDatos;

        public ObservableCollection<detallecuestionario> listaDetalleCapaDatos
        {
            get
            {
        ...
        public string respuestaCuestionarioDp
        {
            ...
            set
            {
                ...
                currentEntidadDetalle.respuestaCuestionarioDp = value;
            }
        }
        ...
        public RelayCommand<DetalleCuestionarioModelo> SelectionDetalleChangedCommand { get; set; }
        ...
        #region ViewModel Property : registroGuardarDetallePrograma DetalleCuestionarioModelo

        public const string registroGuardarDetalleProgramaPropertyName = "registroGuardarDetallePrograma";

        private DetalleCuestionarioModelo _registroGuardarDetallePrograma;

        public DetalleCuestionarioModelo registroGuardarDetallePrograma
        {
            get
            {
        ...
        public DetalleCuestionarioViewModel(string origen)
        {
            ...
            switch (origen)
            {
                case "EncargoDocumentacionCuestionarios":
                    _menuElegido = "Documentacion";
                    _nombreopcionor = "Cuestionarios";
                    ...
                    _tokenRecepcionDatosPadre = "datosDocumentacionDetalleCuestionario";//Modificado
                    _tokenEnvioVista = "listaDocumentacionDetalleCuestionarioVista";//Modificado
                    _tokenEnvioProgramas = "EncargoDocumentacionCuestionarioAuditoriaDetalle";//Modificado
                    _tokenEnvioDetallePrograma = "DatosDocumentacionParaCuestionarioDetalle";
                    _tokenRecepcionPadrePrincipal = "Cuestionarios" + "Documentacion";
                    _tokenRecepcionVista = "EncargoPlanificacionCuestionarioCambioOrden";
                    _tokenHabilitarVentanaPadre = "HabilitarDocumentacionVentanaPadreEncargoPlanEdicionCuestionario";
                    ...
                    _tokenEnvioDatosAMenu = "DetalleCuestionarioRegreso";
                    #endregion tokens
                    ...
                    break;
                case "EncargoPlaneacionCuestionarios":
                    #region tokens
                    _tokenRecepcionCierre = "CierreEncargoPlanCuestionarioSub-ventana"; //Modificado
                    ...
                    _tokenRecepcionPadrePrincipal = "Cuestionarios" + "Planificación";
            ...
            currentEntidadDetalle = new DetalleCuestionarioModelo();
            ...
            listarespuestacuestionario= new ObservableCollection<string>(TipoRespuestaCuestionarioModelo.GetAllDisplayTexto());
            listatiporespuestacuestionario = new ObservableCollection<tiporespuestacuestionario>();
            listaDetalleCapaDatos = new ObservableCollection<detallecuestionario>();
            ...
            currentEntidadDetalle = new DetalleCuestionarioModelo();
            registroGuardarDetallePrograma = new DetalleCuestionarioModelo();
        ...
        private void permisos()
        {
            if (currentUsuario.listaPermisos != null)
            {
                try
                {
                    ...
                    {
                        case "EncargoDocumentacionCuestionarios"://Llamada desde documentacion plan indices
                            ...
                            if (currentUsuario.listaPermisos.Count(x => x.nombreopcionpru.ToUpper() == nombreopcionor.ToUpper()) > 0)
                            {
                                ...
                                //_menuElegido = "Documentacion";
                                //_nombreopcionor = origen;//Balances
        ...
        private void ControlProgramaDatosMsj(ProgramaDatosMsj programaDatosMsj)
        {
            ...
            currentEntidadDetalle = programaDatosMsj.detalleCuestionario;
        ...
        private void procesamiento()
        {
            ...
            listaDetalleCapaDatos = new ObservableCollection<detallecuestionario>(DetalleCuestionarioModelo.GetAllCapaDatos(currentPrograma.idprograma));
            listatiporespuestacuestionario = new ObservableCollection<tiporespuestacuestionario>(TipoRespuestaCuestionarioModelo.GetAllDisplay());
            ...
            listaDetalleHerramienta = new ObservableCollection<DetalleCuestionarioModelo>(DetalleCuestionarioModelo.GetAllVistaEjecucion(currentPrograma.idprograma,currentEncargo.idencargo));
                    ...
                    if (!((item.nombreTipoProcedimiento.ToUpper() == "Alcance".ToUpper()) || (item.nombreTipoProcedimiento.ToUpper() == "Sub-Alcance".ToUpper() || (item.nombreTipoProcedimiento.ToUpper() == "Sub-sub-Alcance".ToUpper()))))
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                //Ajustar la accesibilidad de la pregunta del  padre
                                try
                                {
        ...
        private void ActualizarlistaDetallePrograma()
        {
            ...
            try
            {
                ...
                {
                    //No se reordena
                    listaDetallePrograma = new ObservableCollection<DetalleCuestionarioModelo>(DetalleCuestionarioModelo.GetAll(currentPrograma.idprograma,false,currentEncargo.idencargo));
                }
        ...
        public async Task<int> guardarlistaDetalleProgramaEjecucion()
        {
            try
            {
                int resultado = -1;
                int caso = 0;
                foreach (DetalleCuestionarioModelo item in listaDetalleProcedimientos)
        ...
        private void RegisterCommands()
        {
            ...
            SelectionDetalleChangedCommand = new RelayCommand<DetalleCuestionarioModelo>(entidad =>
            {
                if (entidad == null) return;
                currentDetallePrograma = entidad;
        ...
        public void enviarMensajeReferenciacion()
        {
            ...
            elemento.cuestionarioModelo = currentDetallePrograma;
            Messenger.Default.Send(elemento, tokenEnvioDetallePrograma);
        }
        ...
        private async void terminarProcedimiento()
        {
            ...
            if (!(currentDetallePrograma == null))
            {
                ...
                {
                    #region Verificando cambios
                    bool guardar = false;
                    if (currentDetallePrograma.guardadoBase == false && currentDetallePrograma.estadoprocedimientodp != "T")
                    {
                        if (currentDetallePrograma.descripciontrc != null && currentDetallePrograma.descripciontrc != "")
                        {
                            currentDetallePrograma.idtrcdc = listatiporespuestacuestionario.SingleOrDefault(x => x.descripciontrc == currentDetallePrograma.descripciontrc).idtrc;
                            currentDetallePrograma.estadoprocedimientodp = "E";
                            guardar = true;
                        }
                        else
                        {
                            currentDetallePrograma.idtrcdc = null;
                            currentDetallePrograma.estadoprocedimientodp = "E";
                        }
                        if (currentDetallePrograma.comentariodp != null && currentDetallePrograma.comentariodp != "")
                        {
                            guardar = true;
                        }
                        if (currentDetallePrograma.referenciaPt!= null && currentDetallePrograma.referenciaPt != "")
                        {
                            guardar = true;
                        }
                        if (guardar)
                        { 
                        if (DetalleCuestionarioModelo.UpdateModelo(currentDetallePrograma, currentUsuario, currentEncargo.idencargo))
                        {
                            //Se guardo con éxito
                            currentDetallePrograma.guardadoBase = true;
                        }
                        }
                    }
                    ...
                    if (currentDetallePrograma.idtrcdc != null)
                    {
                        accesibilidadWindow = false;
                        //Mouse.OverrideCursor = Cursors.Wait;
                        ...
                        MessageDialogResult result = await dlg.ShowMessageAsync(this, "La acción no podrá revertirse", "¿Desea dar por terminado la pregunta?", MessageDialogStyle.AffirmativeAndNegative, mySettings);

                        if (result == MessageDialogResult.Affirmative)
                        {
                            Mouse.OverrideCursor = Cursors.Wait;
                            if (DetalleCuestionarioModelo.UpdateModeloCierreProcedimiento(currentDetallePrograma, currentUsuario,currentEncargo.idencargo))
                            {
                                Mouse.OverrideCursor = null;
                                await dlg.ShowMessageAsync(this, "Se cerro la pregunta, queda sujeto a revision", "");
                                //actualizarLista();
                                currentDetallePrograma = new DetalleCuestionarioModelo();
                            }
                            else
                        ...
                        {
                            Mouse.OverrideCursor = null;
                            await dlg.ShowMessageAsync(this, "Canceló el cierre de la pregunta", "");
                        }
                    }
                    else
                    {
                        await dlg.ShowMessageAsync(this, "La pregunta no  tiene respuesta ", "Debe responderla para poder cerrarla");
                    }
                }
                else
                {
                    Mouse.OverrideCursor = null;
                    await dlg.ShowMessageAsync(this, "La pregunta ya esta cerrada", "No puede cerrarse dos veces");
                }
            }
            else
            {
        ...
        {
            await dlg.ShowMessageAsync(this, "No implementado", "No requerido");
        }
        ...
        private async void guardarDetalle()
        {
            ...
            MessageDialogResult result = await dlg.ShowMessageAsync(this, "Se guardaran las respuestas", "¿Desea guardar los cambios?", MessageDialogStyle.AffirmativeAndNegative, mySettings);
            ...
            if (result == MessageDialogResult.Affirmative)
            {
                ...
                {
                    if (await guardarlistaDetalleProgramaEjecucion() == -1)
                    {
                        await mensajeAutoCerrado("Se actualizaron las respuestas ", "Este mensaje desaparecerá en 1 segundo", 2);
                        finComando();
                    }
                    else
                    {
