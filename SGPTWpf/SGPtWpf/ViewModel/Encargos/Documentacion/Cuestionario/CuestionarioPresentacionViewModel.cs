...
namespace SGPTWpf.SGPtWpf.Views.Principales.Encargos.Documentacion.Cuestionarios
{
    public sealed class CuestionarioPresentacionViewModel : ViewModeloBase
    {
        ...
        public CuestionarioPresentacionViewModel(string origen)
        {
            ...
            _fechaEjecucion = MetodosModelo.homologacionFecha();
            _salidaRealizada = false;
            _tokenRecepcionEncargos = "datosEncargosCuestionarioDocumentacion"; //Modificado
            _tokenRecepcionEncargosDetalle = "datosEncargosCuestionarioDetalleDocumentacion";//No se utiliza

            _tokenEnvioCierre = "CierreEncargosDocumentacionCuestionarioEncargos";//Modificado
        ...
        private void ControlDetalleHerramientoCrudMensaje(ProgramaDatosMsj herramientasModeloElementoMensajes)
        {
            ...
            {
                listaDetalleHerramienta = new ObservableCollection<DetalleCuestionarioModelo>(DetalleCuestionarioModelo.GetAll(currentEntidad.idprograma,currentEncargo.idencargo));
            ...
            switch (herramientasModeloElementoMensajes.fuenteLlamado)
            {
                ...
                case 2:
                    ...
                    break;
                case 11:
                    tokenEnvioCierre = "CierreEncargosDocumentacionCuestionarioEncargos";//Modificado
                    fuenteLlamado = 11;
                    //listaDetalleHerramienta = new ObservableCollection<DetalleCuestionarioModelo>(DetalleCuestionarioModelo.GetAllVista(currentEntidad.idprograma));
                    //listaDetalleHerramienta = new ObservableCollection<DetalleCuestionarioModelo>(DetalleCuestionarioModelo.GetAll(currentEntidad.idprograma));
                    break;
                case 12:
        ...
        private async void imprimirReporte()
        {
            ...
            if (resultk == MessageDialogResult.Affirmative)
            {
                ...
                msj.TipoReporteAGenerar = TipoReporteAGenerar.ReporteCuestionario;
                ...
                ReportesAImpresionMainModel.TypeName = "ReporteCuestionario";
