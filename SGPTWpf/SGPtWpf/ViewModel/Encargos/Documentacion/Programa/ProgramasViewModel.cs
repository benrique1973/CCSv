...

{
    ...
    public sealed class ProgramasViewModel : ViewModeloBase
    {
        ...
        private ObservableCollection<menuDocumentacionPrograma> _listaVistas;

        public ObservableCollection<menuDocumentacionPrograma> listaVistas
        {
            get
            {
                return _listaVistas;
        ...
        #region EncargoProgramaMainModel

        private MainModel _mainModel = null;

        public MainModel EncargoProgramaMainModel
        {
            get
            {
                return _mainModel;
        ...
        public ProgramasViewModel(string origen)
        {
            ...
            switch (origen)
            {
                case "MenuDocumentacion":
                    ...
                    //_tokenRecepcionPadre = "recepcionDatos";//Permite captar los mensajes del  menú planificacion

                    _tokenRecepcionCierrePreView = "CierreEncargosDocumentacionPrograma";//Modificado Sirve tanto para los programas en vista previa como para el controllador;

                    _tokenEnvioProgramas = "datosEncargosProgramaDocumentacion";//Modificado, Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionController = "datosControllerProgramaDocumentacion"; //Modificado

                    _tokenRecepcionPadre = "Programas" + "Documentacion";

                    _tokenEnvioPlanificacion = "inicioProgramasDocumentacion";

                    _tokenEnvioDetalles = "datosDocumentacionDetallePrograma";
                    ...
                    opcionTipoHerramientaprograma = 1;//Por ser un programa para  cuestionario es 2,, para programa es 1
                    ...
                    //Seleccion de opcion de opciones (Programa o Programa)
                    EncargoProgramaMainModel = new MainModel();
                    listaVistas = new ObservableCollection<menuDocumentacionPrograma>(menuDocumentacionPrograma.GetAll());
                    _tokenRecepcionSubMenu = "DetalleProgramaRegreso";
                ...
                default:
                    ...
                    _tokenRecepcionPadre = "Programas" + "Planificación";//Permite captar los mensajes del  menú planificacion
                    ...
                    Messenger.Default.Register<EncargosDatosMsj>(this, tokenRecepcionPadre, (planificacionDatos) => ControlRecepcionDatos(planificacionDatos));
        ...
        private void permisos()
        {
            if (usuarioModelo.listaPermisos != null)
            {
                try
                {
                    ...
                    {
                        case "MenuDocumentacion"://Llamada desde documentacion plan indices
                            #region configuracion
        ...
        public void enviarMensaje()
        {
            ...
            elemento.detallePrograma = currentEntidadDetalle; ;//Para el caso de  edicion de programas
        ...
        {
            EncargoProgramaMainModel.TypeName = null;
            switch (comando)
            {
                case 1:
        ...
        public void Nuevo()
        {
            ...
            EncargoProgramaMainModel.TypeName = "ProgramaModeloCrearView";
        ...
        public async void Editar()
        {
            if (!(currentEntidad == null))
            {
                if (currentEntidad.idtpprograma != 1)//Es un programa estándar debe modificarlo desde herramientas
                {
                    iniciarComando();
                    comando = 2;
                    EncargoProgramaMainModel.TypeName = "ProgramaModeloEditarView";
                    #region Configuracion
                    currentEntidad.usuarioModifico = usuarioModelo.inicialesusuario.ToUpper();
                    currentEntidad.usuarioModeloPrograma = usuarioModelo;
        ...
        public async void Consultar()
        {
            if (!(currentEntidad == null))
            {
                iniciarComando();
                comando = 3;
                EncargoProgramaMainModel.TypeName = "ProgramaModeloConsultarView";
                #region Configuracion
                currentEntidad.usuarioModifico = usuarioModelo.inicialesusuario.ToUpper();
                currentEntidad.usuarioModeloPrograma = usuarioModelo;
                currentEntidad.usuarioProgramaAccionModelo.rolUsuarioModelo = RolUsuarioModelo.GetRegistro("M");
        ...
        public async void Borrar()
        {
            ...
            if (!(currentEntidad == null))
            {
                ...
                {
                    await dlg.ShowMessageAsync(this, "El programa ya tiene procedimientos ejecutados, no puede eliminarse", "solo puede  eliminar o modificar los procedimientos  no  iniciados en forma individual");
                }
            }
            else
            {
        ...
        public async void BorrarLogico()
        {
            if (!(currentEntidad == null))
            {
                ...
                {
                    await dlg.ShowMessageAsync(this, "El programa ya tiene preguntas con respuestas, no puede eliminarse", "solo puede  eliminar o modificar los procedimientos  no  iniciados en forma individual");
                }
            }
            else
            {
        ...
        private async void bitacolaHistoria()
        {
            //Nuestra el historial de operaciones del cuestionario
            {
                if (!(currentEntidad == null))
                {
                    ...
                    EncargoProgramaMainModel.TypeName = "ProgramaModeloBitacoraView";
                    #region Configuracion
                    currentEntidad.usuarioModifico = usuarioModelo.inicialesusuario.ToUpper();
                    currentEntidad.usuarioModeloPrograma = usuarioModelo;
                    currentEntidad.usuarioProgramaAccionModelo.rolUsuarioModelo = RolUsuarioModelo.GetRegistro("M");
            ...
            if (!(currentEntidad == null))
            {
                ...
                if (currentEntidad.etapaprograma != "T") //Hay cero procedimientos diferentes a iniciados
                {
                    if (avance >= 100)
                    {
                        ...
                        MessageDialogResult result = await dlg.ShowMessageAsync(this, "La acción no podrá revertirse", "¿Desea dar por terminado el programa?", MessageDialogStyle.AffirmativeAndNegative, mySettings);

                        if (result == MessageDialogResult.Affirmative)
                        {
                            Mouse.OverrideCursor = Cursors.Wait;
                            if (ProgramaModelo.UpdateCierreByPrograma(currentEntidad.idprograma, usuarioModelo,currentEncargo.idencargo))
                            {
                                Mouse.OverrideCursor = null;
                                await dlg.ShowMessageAsync(this, "Se cerro el programa, queda sujeto a revision", "");
                                actualizarLista();
                                currentEntidad = new ProgramaModelo();
                            }
                            else
                        ...
                        {
                            Mouse.OverrideCursor = null;
                            await dlg.ShowMessageAsync(this, "Canceló el cierre del programa", "");
                        }
                    }
                    else
                    {
                        await dlg.ShowMessageAsync(this, "El programa no esta completo tiene un avance " + string.Format(CultureInfo.InvariantCulture,
                        "{0:0,0.00}", avance) + " % ", "Debe completarlo para cerrar el programa");
                    }
                }
                else
                {
                    Mouse.OverrideCursor = null;
                    await dlg.ShowMessageAsync(this, "El programa ya esta cerrado", "No puede cerrarse dos veces");
                }
            }
            else
            {
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    EncargoProgramaMainModel.TypeName = "ProgramaModeloReferenciarView";
                    #region Configuracion
                    currentEntidad.usuarioModifico = usuarioModelo.inicialesusuario.ToUpper();
                    currentEntidad.usuarioModeloPrograma = usuarioModelo;
                    currentEntidad.usuarioProgramaAccionModelo.rolUsuarioModelo = RolUsuarioModelo.GetRegistro("M");
        ...
        public async void Importar()
        {
            ...
            if (result == MessageDialogResult.Affirmative)
            {
                ...
                EncargoProgramaMainModel.TypeName = "ProgramaModeloImportarPlantillaView";
            ...
            else
            {
                if (result == MessageDialogResult.Negative)
                {
                    ...
                    EncargoProgramaMainModel.TypeName = "ProgramaModeloImportarEncargoView";
        ...
        private async void VistaPrograma()
        {
            if (!(currentEntidad == null))
            {
                ...
                comando = 5;
                accesibilidadWindow = false;
                EncargoProgramaMainModel.TypeName = "ProgramaModeloVerProgramaView";
                //enviarElemento(currentEntidad);
                enviarMensajeCrud(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
                //enviarMensaje();
        ...
        private async void VistaProgramaEjecucion()
        {
            if (!(currentEntidad == null))
            {
                ...
                comando = 5;
                accesibilidadWindow = false;
                EncargoProgramaMainModel.TypeName = "ProgramaEjecucionVerProgramaView";
                //enviarElemento(currentEntidad);
                enviarMensajeCrud(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
                //enviarMensaje();
