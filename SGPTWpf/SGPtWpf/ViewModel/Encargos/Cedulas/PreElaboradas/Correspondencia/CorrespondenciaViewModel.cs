...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.PreElaboradas.Correspondencia
{

    public sealed class CorrespondenciaViewModel : ViewModeloBase
    {
        ...
        //12;"CedulaCorrespondencias";"A";TRUE
        //13;"Marcas";"A";TRUE
        ...
        private ObservableCollection<cedulacorrespondencia> _SelectedItems;

        public ObservableCollection<cedulacorrespondencia> SelectedItems
        {
            get
            {
        ...
        private ObservableCollection<cedulacorrespondencia> _lista;

        public ObservableCollection<cedulacorrespondencia> lista
        {
            get
            {
                return _lista;
        ...
        private cedulacorrespondencia _currentEntidadDetalle;

        public cedulacorrespondencia currentEntidadDetalle
        {
            get
            {
        ...
        public RelayCommand<cedulacorrespondencia> SelectionChangedCommand { get; set; }
        ...
        public CorrespondenciaViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public CorrespondenciaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                case "cedulasCorrespondencia":
                    ...
                    _tokenRecepcionPadre = "Correspondencia" + "Cédulas";//Permite captar los mensajes del  menú planificacion, corresponde a Indices

                    _tokenEnvioDatosAHijo = "datosEncargoCedulasCorrespondencia";//Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulasCorrespondenciaController";

                    #endregion

                    RegisterCommands();
                    _tablaDetalle = "Correspondencia";
                    break;
            ...
            lista = new ObservableCollection<cedulacorrespondencia>();//Lista vacia no se conoce el encargo y el cliente
        ...
        private async void ControlRecepcionDatos(EncargosDatosMsj msj)
        {
            ...
            currentEntidad = CedulaModelo.FindMaestro(currentEncargo.idencargo, idtc, "Cédula de correspondencia");
            switch (currentEntidad.idcedula)
            {
                ...
                case 0:
                    ...
                    currentEntidad.titulocedula = "Cédula de correspondencia";
        ...
        private void actualizarLista()
        {
            ...
            try
            {
                ...
                {
                    var listaCapaDatos = _context.cedulacorrespondencias.Where(entidad => (entidad.idencargo == currentEntidad.idencargo
                    && entidad.estadoccorrespondencia == "A"
                    && entidad.idcedula == currentEntidad.idcedula));
                    lista = new ObservableCollection<cedulacorrespondencia>(listaCapaDatos);
                }
            }
            catch (Exception e)
            {
        ...
        {
            //Se crea el mensaje
            CorrespondenciaMsj elemento = new CorrespondenciaMsj();
        ...
        public void Nuevo()
        {
            ...
            ECMainModel.TypeName = "CedulaCorrespondenciasCrearview";
            #endregion
        ...
        public async void Editar()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                ECMainModel.TypeName = "CedulaCorrespondenciasEditarView";
        ...
        public async void Consultar()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                comando = 3;
                //currentEntidadDetalle.usuarioModelo = usuarioModelo;
                ECMainModel.TypeName = "CedulaCorrespondenciasConsultarView";
                enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        public void Actualizar(ObservableCollection<cedulacorrespondencia> listaEntidad)
        {
            lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<cedulacorrespondencia>(entidad =>
            {
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaCorrespondenciasReferenciarView";
        ...
        private async void aprobarPapel()
        {
            if (!(currentEntidad == null))
            {
                ...
                ECMainModel.TypeName = "CedulaCorrespondenciasAprobarView";
                #region Configuracion
                currentEntidad.usuarioModelo = usuarioModelo;
                #endregion
                enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaCorrespondenciasSupervisarView";
                    #region Configuracion
                    currentEntidad.usuarioModelo = usuarioModelo;
                    #endregion
                    enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidad == null))
            {
                ...
                if (estadoDocumento == 1) //Hay cero procedimientos diferentes a iniciados
                {
                    if (currentEntidad.referenciacedula != string.Empty)
                    {
                        ...
                        ECMainModel.TypeName = "CedulaCorrespondenciasCerrarView";
                        #region Configuracion
                        currentEntidad.usuarioModelo = usuarioModelo;
                        #endregion
                        enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private async void ConsultarCierre()
        {
            ...
            if (!(currentEntidad == null))
            {
                ...
                ECMainModel.TypeName = "CierrecedulacorrespondenciasConsultarView";
                enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void vistaPapel()
        {
            ...
            ECMainModel.TypeName = "CedulaCorrespondenciasVerView";
            enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            //}
            //else
            //{
        ...
        public async void Importar()
        {
            ...
            if (result == MessageDialogResult.Affirmative)
            {
                ...
                ECMainModel.TypeName = "CedulaCorrespondenciasImportarView";
