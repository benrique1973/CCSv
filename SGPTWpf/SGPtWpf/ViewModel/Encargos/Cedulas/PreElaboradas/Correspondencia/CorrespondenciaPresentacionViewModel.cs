...
{
    public sealed class CorrespondenciaPresentacionViewModel : ViewModeloBase
    {
        ...
        public CorrespondenciaPresentacionViewModel()
        {

        }

        public CorrespondenciaPresentacionViewModel(string origen)
        {
            ...
            switch (origen)
            {
                case "CedulaCorrespondencias":
                    ...
                    _tokenEnvioCierre = "datosEncargoCedulasCorrespondenciaController";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de correspondencia";
                    break;
            }
            //Mensaje de vista desde el menu principal
            Messenger.Default.Register<CorrespondenciaMsj>(this, tokenRecepcion, (ElementoMsj) => ControlDetalleHerramientoCrudMensaje(ElementoMsj));
        ...
        private void ControlDetalleHerramientoCrudMensaje(CorrespondenciaMsj ElementoMsj)
        {
            //Procesos normal
            ...
            //Desuscribir mensaje
            Messenger.Default.Unregister<CorrespondenciaMsj>(this, tokenRecepcion);//Proviene de pantalla principal
