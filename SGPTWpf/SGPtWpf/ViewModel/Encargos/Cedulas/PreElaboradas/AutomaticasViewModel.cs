...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.PreElaboradas
{

    public sealed class AutomaticasViewModel : ViewModeloBase
    {
        ...
        public AutomaticasViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public AutomaticasViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                case "cedulasCorrespondencia":
                    ...
                    _tokenRecepcionCierrePreView = "EncargoCedulasCorrespondencia";//Sirve tanto para los programas en vista previa como para el controllador;
                    ...
                    #endregion
                    RegisterCommands();
                    _tablaDetalle = "detalleCorrespondencia";
                    break;
                case "cedulasReuniones":
                    fuenteLlamado = 1;
                    _idtc = 9;//Sumarias
                    //9;"Reuniones";"A";TRUE
                    //10;"Contactos";"A";TRUE
                    ...
                    //Indica la clase de documento
                    #region tokens
                    _tokenRecepcionPadre = "Reuniones" + "Cédulas";//Permite captar los mensajes del  menú planificacion, corresponde a Indices
                    _tokenRecepcionCierrePreView = "EncargoCedulasReuniones";//Sirve tanto para los programas en vista previa como para el controllador;
                    _tokenEnvioDatosAHijo = "datosEncargoCedulasReuniones";//Para control de los datos que  remite programas a sub-ventanas
                    _tokenRecepcionHijo = "datosEncargoCedulasReunionesController";
                    #endregion
                    RegisterCommands();
                    _tablaDetalle = "detalleReuniones";
                    break;
                case "cedulasContactos":
                    ...
                    _tokenRecepcionCierrePreView = "EncargoCedulasContactos";//Sirve tanto para los programas en vista previa como para el controllador;
                    ...
                    #endregion
                    RegisterCommands();
                    _tablaDetalle = "detalleContactos";
                    break;
            }
        ...
        private async void vistaPapel()
        {
            if (!(currentEntidad == null))
            {
                ...
                ECMainModel.TypeName = "IndiceEncargoPlanVistaPreviaView";
                enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            }
            else
            {
