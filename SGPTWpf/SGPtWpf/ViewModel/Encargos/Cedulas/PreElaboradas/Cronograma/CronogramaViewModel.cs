...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.PreElaboradas.Cronograma
{
    ...
    public sealed class CronogramaViewModel : ViewModeloBase
    {
        ...
        public CronogramaViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public CronogramaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                case "cedulasCronograma":
                    ...
                    _tokenRecepcionPadre = "Cronograma" + "Cédulas";//Permite captar los mensajes del  menú planificacion, corresponde a Indices

                    _tokenEnvioDatosAHijo = "datosEncargoCedulasCronograma";//Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulasCronogramaController";

                    #endregion

                    RegisterCommands();
                    _tablaDetalle = "Cronograma";
                    break;
        ...
        {
            //Se crea el mensaje
            CronogramaMsj elemento = new CronogramaMsj();
        ...
        public void Nuevo()
        {
            ...
            ECMainModel.TypeName = "CronogramaCrearview";
            #endregion
        ...
        public async void Editar()
        {
            ...
            if (lista.Where(x => x.IsSelected).Count() == 1)
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CronogramaEditarView";
        ...
        public async void Consultar()
        {
            ...
            if (lista.Where(x => x.IsSelected).Count() == 1)
            {
                if (!(currentEntidad == null))
                {
                    ...
                    comando = 3;
                    currentEntidad.usuarioModelo = usuarioModelo;
                    ECMainModel.TypeName = "CronogramaConsultarView";
                    enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void vistaPapel()
        {
            ...
            ECMainModel.TypeName = "CronogramaVerView";
            enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            //}
            //else
            //{
