...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Sumarias
{
    ...
    public sealed class CronogramaControllerViewModel : ViewModeloBase
    {
        ...
        public CronogramaControllerViewModel()
        {
        }

        public CronogramaControllerViewModel(string origenLlamada)
        {
            ...
            {
                case "DocumentacionCronograma"://Llamada desde Documentacion/Carpetas
                    #region configuracion Documentacion
                    _tokenEnvio = "datosEncargoCedulasCronogramaControllern ";//Modificado
            ...
            //Suscribiendo el mensaje
            Messenger.Default.Register<CronogramaMsj>(this, tokenRecepcion, (datosMsj) => ControlDatosMsj(datosMsj));
        ...
        private async void ControlDatosMsj(CronogramaMsj datosMsj)
        {
            ...
            Messenger.Default.Unregister<CronogramaMsj>(this, tokenRecepcion);
            finComando();
