...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.PreElaboradas
{
    ...
    public sealed class AutomaticasControllerViewModel : ViewModeloBase
    {
        ...
        public AutomaticasControllerViewModel()
        {
        }

        public AutomaticasControllerViewModel(string origenLlamada)
        {
