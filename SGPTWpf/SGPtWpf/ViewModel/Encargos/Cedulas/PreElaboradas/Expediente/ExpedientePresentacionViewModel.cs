...
{
    public sealed class ExpedientePresentacionViewModel : ViewModeloBase
    {
        ...
        public ExpedientePresentacionViewModel()
        {

        }

        public ExpedientePresentacionViewModel(string origen)
        {
            ...
            switch (origen)
            {
                case "cedulaExpediente":
                    _tokenRecepcion = "datosEncargoCedulasExpediente"; //Modificado
                    _tokenEnvioCierre = "datosEncargoCedulasExpedienteController";//Modificado
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Expediente  de cliente";
                    break;
            }
            //Mensaje de vista desde el menu principal
            Messenger.Default.Register<ExpedienteMsj>(this, tokenRecepcion, (ElementoMsj) => ControlCrudMensaje(ElementoMsj));
        ...
        private void ControlCrudMensaje(ExpedienteMsj ElementoMsj)
        {
            //Procesos normal
            ...
            //Desuscribir mensaje
            Messenger.Default.Unregister<ExpedienteMsj>(this, tokenRecepcion);//Proviene de pantalla principal
