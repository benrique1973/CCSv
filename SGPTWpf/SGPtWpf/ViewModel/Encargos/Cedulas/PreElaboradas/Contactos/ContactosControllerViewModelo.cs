...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.PreElaboradas.Contactos
{
    ...
    public sealed class ContactosControllerViewModelo : ViewModeloBase
    {
        ...
        public ContactosControllerViewModelo()
        {
        }

        public ContactosControllerViewModelo(string origenLlamada)
        {
            ...
            {
                case "DocumentacionCedulasContactos"://Llamada desde Documentacion/Carpetas
                    #region configuracion Documentacion
                    _tokenEnvio =  "datosEncargoCedulasContactosController";
                    _tokenRecepcion = "datosEncargoCedulasContactos"; //Modificado
                    #endregion
                    break;

            }
            //Suscribiendo el mensaje
            Messenger.Default.Register<ContactoMsj>(this, tokenRecepcion, (datosMsj) => ControlDatosMsj(datosMsj));
        ...
        private async void ControlDatosMsj(ContactoMsj datosMsj)
        {
            ...
            Messenger.Default.Unregister<ContactoMsj>(this, tokenRecepcion);
            finComando();
