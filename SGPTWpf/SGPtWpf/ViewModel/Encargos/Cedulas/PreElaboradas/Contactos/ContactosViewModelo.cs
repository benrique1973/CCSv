...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.PreElaboradas.Contactos
{

    public sealed class ContactosViewModelo : ViewModeloBase
    {
        ...
        private ObservableCollection<cedulacontacto> _SelectedItems;

        public ObservableCollection<cedulacontacto> SelectedItems
        {
            get
            {
        ...
        private ObservableCollection<cedulacontacto> _lista;

        public ObservableCollection<cedulacontacto> lista
        {
            get
            {
                return _lista;
        ...
        private cedulacontacto _currentEntidadDetalle;

        public cedulacontacto currentEntidadDetalle
        {
            get
            {
        ...
        public RelayCommand<cedulacontacto> SelectionChangedCommand { get; set; }
        ...
        public ContactosViewModelo()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public ContactosViewModelo(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                case "cedulasContactos":
                    ...
                    _tokenRecepcionPadre = "Contactos" + "Cédulas";//Permite captar los mensajes del  menú planificacion, corresponde a Indices

                    _tokenEnvioDatosAHijo = "datosEncargoCedulasContactos";//Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulasContactosController";

                    #endregion

                    RegisterCommands();
                    _tablaDetalle = "Contactos";
                    break;
            ...
            lista = new ObservableCollection<cedulacontacto>();//Lista vacia no se conoce el encargo y el cliente
        ...
        private async void ControlRecepcionDatos(EncargosDatosMsj msj)
        {
            ...
            currentEntidad = CedulaModelo.FindMaestro(currentEncargo.idencargo, idtc, "Cédula de contactos");
            switch (currentEntidad.idcedula)
            {
                ...
                case 0:
                    ...
                    currentEntidad.titulocedula = "Cédula de contactos";
        ...
        private void actualizarLista()
        {
            ...
            try
            {
                    ...
                    {
                        var listaCapaDatos = _context.cedulacontactos.Where(entidad => (entidad.idencargo == currentEntidad.idencargo 
                        && entidad.estadoccontacto == "A"
                        && entidad.idcedula==currentEntidad.idcedula));
                        lista = new ObservableCollection<cedulacontacto>(listaCapaDatos);
                    }
            }
            catch (Exception e)
            {
        ...
        {
            //Se crea el mensaje
            ContactoMsj elemento = new ContactoMsj();
        ...
        public void Nuevo()
        {
            ...
            ECMainModel.TypeName = "CedulaContactosCrearview";
            #endregion
        ...
        public async void Editar()
        {
            ...
            //ControlCambioLista(true);
                ...
                if (!(currentEntidadDetalle == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaContactosEditarView";
        ...
        public async void Consultar()
        {
            ...
            // ControlCambioLista(true);
                ...
                if (!(currentEntidadDetalle == null))
                {
                    ...
                    comando = 3;
                    //currentEntidadDetalle.usuarioModelo = usuarioModelo;
                    ECMainModel.TypeName = "CedulaContactosConsultarView";
                    enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        public void Actualizar(ObservableCollection<cedulacontacto> listaEntidad)
        {
            lista = listaEntidad;
        }
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<cedulacontacto>(entidad =>
            {
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaContactosReferenciarView";
        ...
        private async void aprobarPapel()
        {
            if (!(currentEntidad == null))
            {
                ...
                ECMainModel.TypeName = "CedulaContactosAprobarView";
                #region Configuracion
                currentEntidad.usuarioModelo = usuarioModelo;
                #endregion
                enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaContactosSupervisarView";
                    #region Configuracion
                    currentEntidad.usuarioModelo = usuarioModelo;
                    #endregion
                    enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidad == null))
            {
                ...
                if (estadoDocumento == 1) //Hay cero procedimientos diferentes a iniciados
                {
                    if (currentEntidad.referenciacedula != string.Empty)
                    {
                        ...
                        ECMainModel.TypeName = "CedulaContactosCerrarView";
                        #region Configuracion
                        currentEntidad.usuarioModelo = usuarioModelo;
                        #endregion
                        enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private async void ConsultarCierre()
        {
            //Para guardar lo que esta en la  pantalla
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CierreCedulaContactosConsultarView";
                    enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void vistaPapel()
        {
            ...
            ECMainModel.TypeName = "CedulaContactosVerView";
            enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            //}
            //else
            //{
        ...
        public async void Importar()
        {
            ...
            if (result == MessageDialogResult.Affirmative)
            {
                ...
                ECMainModel.TypeName = "CedulaContactosImportarView";
