...
{
    public sealed class ContactosPresentacionViewModel : ViewModeloBase
    {
        ...
        public ContactosPresentacionViewModel()
        {

        }

        public ContactosPresentacionViewModel(string origen)
        {
            ...
            switch (origen)
            {
                case "cedulaContactos":
                    ...
                    _tokenEnvioCierre = "datosEncargoCedulasContactosController";//Modificado
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de contactos";
                    break;
            }
            //Mensaje de vista desde el menu principal
            Messenger.Default.Register<ContactoMsj>(this, tokenRecepcion, (ElementoMsj) => ControlDetalleHerramientoCrudMensaje(ElementoMsj));
        ...
        private void ControlDetalleHerramientoCrudMensaje(ContactoMsj ElementoMsj)
        {
            //Procesos normal
            ...
            //Desuscribir mensaje
            Messenger.Default.Unregister<ContactoMsj>(this, tokenRecepcion);//Proviene de pantalla principal
