...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas
{
    public sealed class CedulasViewModel : ViewModeloBase
    {
        ...
        private MenuCedulas _currentEntidad;

        public MenuCedulas currentEntidad
        {
            get
            {
        ...
        private ObservableCollection<MenuCedulas> _listaVistas;

        public ObservableCollection<MenuCedulas> listaVistas
        {
            get
            {
                return _listaVistas;
        ...
        public CedulasViewModel()
        {
            _opcionSeleccionada = 0;
            _valorRetornado = 0;
            _tokenRecepcionSeleccionCliente = "Cédulas" + "ClienteSeleccionado";//Proviene de  EncargosControllerViewModel;

            _tokenEnvioPadre = string.Empty;//Para comunicar los mensajes a las sub-ventanas
            _tokenRecepcionEncargos = "Cédulas" + "MenuEncargos";
            ...
            listaVistas = new ObservableCollection<MenuCedulas>(MenuCedulas.GetAll());
            _opcionSeleccionada = 0;
            ...
            currentEntidad = new MenuCedulas();
        ...
        public void Mostrar()
        {
            ...
            else
            {
                ...
                tokenEnvioPadre = currentEntidad.ViewDisplay + "Cédulas";//Se personaliza segun el destinatario
                ...
                listaVistas = new ObservableCollection<MenuCedulas>(MenuCedulas.GetAll());
                foreach (MenuCedulas item in listaVistas)
                {
