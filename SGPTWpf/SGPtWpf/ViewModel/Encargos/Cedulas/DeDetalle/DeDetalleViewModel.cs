...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.DeDetalle
{

    public sealed class DeDetalleViewModel : ViewModeloBase
    {
        ...
        public DeDetalleViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public DeDetalleViewModel(string origen)//Documentacion/Carpetas
        {
