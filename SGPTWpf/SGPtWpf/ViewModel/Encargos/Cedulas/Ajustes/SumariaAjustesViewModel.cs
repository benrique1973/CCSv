...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Ajustes
{
    ...
    public sealed class SumariaAjustesViewModel : ViewModeloBase
    {
        ...
        public SumariaAjustesViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public SumariaAjustesViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                ...
                case "cedulasAjustes":
                    ...
                    _tokenRecepcionPadre = "Ajustes y reclasificaciones" + "Cédulas";//Permite captar los mensajes del  menú planificacion, corresponde a Indices

                    _tokenEnvioDatosAHijo = "datosEncargoCedulasAjustesMenuPrincipal";//Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulasAjustesControllerMenuPrincipal";

                    _tokenRecepcionCierrePreView = "EncargoCedulasAjustesMenuPrincipal";//Sirve tanto para los programas en vista previa como para el controllador;

                    #endregion

                    _tablaDetalle = "Ajustes y reclasificaciones";
                    _tablaResumen = "resumenAjustescedulas";
                    RegisterCommands();
        ...
        public void enviarMensajeAjustes()
        {
            //Se crea el mensaje
        ...
        public void Nuevo()
        {
            ...
            switch (idtc)//Depende del tipo de cedula
            {
                case 1:
                    ...
                    break;
                default :
                    ECMainModel.TypeName = "CedulaModeloAjustesCrearview";
                    break;
            }
            #endregion
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        default :
                            ECMainModel.TypeName = "CedulaModeloAjustesEditarView";
                            break;
                    }
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        default :
                            ECMainModel.TypeName = "CedulaModeloAjustesConsultarView";
                            break;
                    }
                    enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void seleccionarVisita()
        {
            ...
            switch (idtc)//Depende del tipo de cedula
            {
                case 1:
                    ...
                    break;
                default :
                    ECMainModel.TypeName = "CedulaModeloAjustesSeleccionarVisitaView";
                    break;
            }
            #endregion
            activarCaptura = true;
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        default :
                            ECMainModel.TypeName = "CedulaModeloAjustesReferenciarView";
                            break;
                    }
            ...
            if (!(currentEntidad == null))
            {
                ...
                switch (idtc)//Depende del tipo de cedula
                {
                    case 1:
                        ...
                        break;
                    default :
                        ECMainModel.TypeName = "CedulaModeloAjustesAprobarView";
                        break;
                }
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        default :
                            ECMainModel.TypeName = "CedulaModeloAjustesSupervisarView";
                            break;
                    }
                    ...
                    if (currentEntidad.referenciacedula != string.Empty)
                    {
                        ...
                        switch (idtc)//Depende del tipo de cedula
                        {
                            case 1:
                                ...
                                break;
                            default :
                                ECMainModel.TypeName = "CedulaModeloAjustesCerrarView";
                                break;
                        }
                        #region Configuracion
                        currentEntidad.usuarioModelo = usuarioModelo;
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        default :
                            ECMainModel.TypeName = "CierreTipoCarpetaModeloAjustesConsultarView";
                            break;
                    }
                    enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidad == null))
            {
                ...
                switch (idtc)//Depende del tipo de cedula
                {
                    case 1:
                        ...
                        break;
                    default :
                        ECMainModel.TypeName = "CedulaSumariaAjustesVerView";
                        enviarMensajeAjustes();
                        break;
                }
            }
