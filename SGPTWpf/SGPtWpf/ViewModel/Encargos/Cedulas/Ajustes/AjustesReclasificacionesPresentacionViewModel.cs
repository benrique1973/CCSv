...
{
    public sealed class AjustesReclasificacionesPresentacionViewModel : ViewModeloBase
    {
        ...
        public AjustesReclasificacionesPresentacionViewModel()
        {

        }

        public AjustesReclasificacionesPresentacionViewModel(string origen)
        {
            #region configuracion general
            enviarMensajeInhabilitar();
            _currentEntidad = new CedulaModelo();
            _currentEntidadDetalle = new CedulaDiarioModelo();
            _lista = new ObservableCollection<CedulaDiarioModelo>();
            ...
            switch (origen)
            {
                case "CedulaAjustesReclasificaciones":
                    _tokenRecepcion = "datosEncargoCedulaAjustesYReclasificaciones";  //Modificado
                    _tokenEnvioCierre = "datosEncargoCedulaAjustesYReclasificacionesController";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de ajustes y reclasificaciones";
                    break;
                case "DocumentacionCedulasAjustesResumen":
                    _tokenEnvioCierre = "datosEncargoCedulasAjustesControllerMenuPrincipal";
                    _tokenRecepcion = "datosEncargoCedulasAjustesMenuPrincipal"; //Modificado
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de ajustes y reclasificaciones";
                    break;
                case "IndiceCedulaAjustesReclasificaciones":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
                    _tokenEnvioCierre = "datosControllerDetalleIndices";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de ajustes y reclasificaciones";
                    break;
                case "ImprimirIndiceCedulaAjustesReclasificaciones":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
            ...
            Messenger.Default.Register<AjustesYReclasificacionesMsj>(this, tokenRecepcion, (ElementoMsj) => ControlDetalleHerramientoCrudMensaje(ElementoMsj));
            ...
            _listaPartidas = new ObservableCollection<CedulaPartidasModelo>();
        }
        private void ControlDetalleHerramientoCrudMensaje(AjustesYReclasificacionesMsj ElementoMsj)
        {
            //Procesos normal
            ...
            llenadoDatos();
            //Desuscribir mensaje
            Messenger.Default.Unregister<AjustesYReclasificacionesMsj>(this, tokenRecepcion);//Proviene de pantalla principal
        ...
        private async void imprimirReporte()
        {
            ...
            if (resultk == MessageDialogResult.Affirmative)
            {
                ...
                EncabezadosSinpiesCedulaAjustesReclasificaciones ep = new EncabezadosSinpiesCedulaAjustesReclasificaciones();
                ...
                msj.TipoReporteAGenerar = TipoReporteAGenerar.CedulaAjustesReclas;

                msj.EncabezadosSinpiesCedulaAjustesReclasificaciones = ep;
                msj.listaAjustesReclasificaciones = lista;


                ReportesAImpresionMainModel.TypeName = "ReporteCedulaAjustesReclasificaciones";
