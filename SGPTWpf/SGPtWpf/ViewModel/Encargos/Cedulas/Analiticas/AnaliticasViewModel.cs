...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Agenda
{

    public sealed class AnaliticasViewModel : ViewModeloBase
    {
        ...
        public AnaliticasViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public AnaliticasViewModel(string origen)//Documentacion/Carpetas
        {
