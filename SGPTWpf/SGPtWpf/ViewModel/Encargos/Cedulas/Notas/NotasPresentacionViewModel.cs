...
{
    public sealed class NotasPresentacionViewModel : ViewModeloBase
    {
        ...
        public NotasPresentacionViewModel()
        {

        }

        public NotasPresentacionViewModel(string origen)
        {
            ...
            switch (origen)
            {
                case "CedulaNotas":
                    ...
                    _tokenEnvioCierre = "datosEncargoCedulasNotasController";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Notas";
                    break;
                case "DocumentacionCedulasNotasResumen":
                    _tokenEnvioCierre = "datosEncargoCedulasNotasControllerMenuPrincipal";
                    _tokenRecepcion = "datosEncargoCedulasNotasMenuPrincipal"; //Modificado
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Notas";
                    break;
                case "IndiceCedulaNotas":
            ...
            Messenger.Default.Register<NotasMsj>(this, tokenRecepcion, (ElementoMsj) => ControlDetalleHerramientoCrudMensaje(ElementoMsj));
        ...
        private void ControlDetalleHerramientoCrudMensaje(NotasMsj ElementoMsj)
        {
            //Procesos normal
            ...
            llenadoDatos();
            //Desuscribir mensaje
            Messenger.Default.Unregister<NotasMsj>(this, tokenRecepcion);//Proviene de pantalla principal
        ...
        private async void imprimirReporte()
        {
            ...
            if (resultk == MessageDialogResult.Affirmative)
            {
                ...
                EncabezadosSinPiesReporteCedulaNotas ep = new EncabezadosSinPiesReporteCedulaNotas();
                ...
                msj.TipoReporteAGenerar = TipoReporteAGenerar.CedulaNotas;

                msj.EncabezadosSinPiesReporteCedulaNotas = ep;
                msj.listaCedulaNotas = lista;

                ReportesAImpresionMainModel.TypeName = "ReporteCedulaNotas";
