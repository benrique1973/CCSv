...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Notas
{
    ...
    public sealed class SumariaNotasViewModel : ViewModeloBase
    {
        ...
        public SumariaNotasViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public SumariaNotasViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                ...
                case "cedulaNotas":
                    ...
                    _tokenEnvioDatosAHijo = "datosEncargoCedulasNotasMenuPrincipal";//Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulasNotasControllerMenuPrincipal";

                    _tokenRecepcionCierrePreView = "EncargoCedulasNotasMenuPrincipal";//Sirve tanto para los programas en vista previa como para el controllador;

                    #endregion

                    _tablaDetalle = "Notas";
                    _tablaResumen = "resumenNotascedulas";
                    RegisterCommands();
        ...
        public void enviarMensajeNotas()
        {
            //Se crea el mensaje
        ...
        public void Nuevo()
        {
            ...
            switch (idtc)//Depende del tipo de cedula
            {
                case 1:
                    ...
                    break;
                case 7://Cedula Notas
                    ECMainModel.TypeName = "CedulaModeloNotasCrearview";
                    break;
            }
            #endregion
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        case 7://Cedula Notas
                            ECMainModel.TypeName = "CedulaModeloNotasEditarView";
                            break;
                    }
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        case 7://Cedula Notas
                            ECMainModel.TypeName = "CedulaModeloNotasConsultarView";
                            break;
                    }
                    enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void seleccionarVisita()
        {
            ...
            switch (idtc)//Depende del tipo de cedula
            {
                case 1:
                    ...
                    break;
                case 7://Cedula Notas
                    ECMainModel.TypeName = "CedulaModeloNotasSeleccionarVisitaView";
                    break;
            }
            #endregion
            activarCaptura = true;
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        case 7://Cedula Notas
                            ECMainModel.TypeName = "CedulaModeloNotasReferenciarView";
                            break;
                    }
            ...
            if (!(currentEntidad == null))
            {
                ...
                switch (idtc)//Depende del tipo de cedula
                {
                    case 1:
                        ...
                        break;
                    case 7://Cedula Notas
                        ECMainModel.TypeName = "CedulaModeloNotasAprobarView";
                        break;
                }
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        case 7://Cedula Notas
                            ECMainModel.TypeName = "CedulaModeloNotasSupervisarView";
                            break;
                    }
                    ...
                    if (currentEntidad.referenciacedula != string.Empty)
                    {
                        ...
                        switch (idtc)//Depende del tipo de cedula
                        {
                            case 1:
                                ...
                                break;
                            case 7://Cedula Notas
                                ECMainModel.TypeName = "CedulaModeloNotasCerrarView";
                                break;
                        }
                        #region Configuracion
                        currentEntidad.usuarioModelo = usuarioModelo;
                ...
                if (!(currentEntidad == null))
                {
                    ...
                    switch (idtc)//Depende del tipo de cedula
                    {
                        case 1:
                            ...
                            break;
                        case 7://Cedula Notas
                            ECMainModel.TypeName = "CierreTipoCarpetaModeloNotasConsultarView";
                            break;
                    }
                    enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidad == null))
            {
                ...
                switch (idtc)//Depende del tipo de cedula
                {
                    case 1:
                        ...
                        break;
                    case 7://Cedula Notas
                        ECMainModel.TypeName = "CedulaSumariaNotasVerView";
                        enviarMensajeNotas();
                        break;
                }
            }
