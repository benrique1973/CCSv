...
{
    public sealed class HallazgosPresentacionViewModel : ViewModeloBase
    {
        ...
        public HallazgosPresentacionViewModel()
        {

        }

        public HallazgosPresentacionViewModel(string origen)
        {
            #region configuracion general
            enviarMensajeInhabilitar();
            _currentEntidad = new CedulaModelo();
            _currentEntidadDetalle = new CedulaHallazgosModelo();
            _lista = new ObservableCollection<CedulaHallazgosModelo>();
            ...
            switch (origen)
            {
                case "CedulaHallazgos":
                    _tokenRecepcion = "datosEncargoCedulasHallazgos";  //Modificado
                    _tokenEnvioCierre = "datosEncargoCedulasHallazgosController";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Hallazgos";
                    break;
                case "DocumentacionCedulasHallazgosResumen":
                    _tokenEnvioCierre = "datosEncargoCedulasHallazgosControllerMenuPrincipal";
                    _tokenRecepcion = "datosEncargoCedulasHallazgosMenuPrincipal"; //Modificado
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Hallazgos";
                    break;
                case "IndiceCedulaHallazgos":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
                    _tokenEnvioCierre = "datosControllerDetalleIndices";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Hallazgos";
                    break;
                case "ImprimirIndiceCedulaHallazgos":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
            ...
            Messenger.Default.Register<HallazgosMsj>(this, tokenRecepcion, (ElementoMsj) => ControlDetalleHerramientoCrudMensaje(ElementoMsj));
        ...
        private void ControlDetalleHerramientoCrudMensaje(HallazgosMsj ElementoMsj)
        {
            //Procesos normal
            ...
            {
                encabezadoPantalla = currentEntidad.titulocedula+ " " +currentEntidad.descripcionvisita.ToLower();
            }
            ...
            llenadoDatos();
            //Desuscribir mensaje
            Messenger.Default.Unregister<HallazgosMsj>(this, tokenRecepcion);//Proviene de pantalla principal
        ...
        private async void imprimirReporte()
        {
            ...
            {
                EncabezadosSinPiesReporteCedulaHallazgos ep = new EncabezadosSinPiesReporteCedulaHallazgos();
                ...
                msj.TipoReporteAGenerar = TipoReporteAGenerar.CedulaHallazgos;

                msj.EncabezadosSinPiesReporteCedulaHallazgos = ep;
                msj.listaCedulaHallazgos = lista;

                ReportesAImpresionMainModel.TypeName = "ReporteCedulaHallazgos";
