...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Hallazgos
{
    ...
    public sealed class SumariaHallazgosViewModel : ViewModeloBase
    {
        ...
        public SumariaHallazgosViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public SumariaHallazgosViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                ...
                //    break;
                #endregion configuracion fin de sumarias
        ...
        public void enviarMensajeHallazgos()
        {
            //Se crea el mensaje
