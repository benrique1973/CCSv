...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Hallazgos
{

    public sealed class HallazgosViewModel : ViewModeloBase
    {
        ...
        //12;"CedulaHallazgosModelos";"A";TRUE
        //13;"Marcas";"A";TRUE
        ...
        private ObservableCollection<CedulaHallazgosModelo> _SelectedItems;

        public ObservableCollection<CedulaHallazgosModelo> SelectedItems
        {
            get
            {
        ...
        private ObservableCollection<CedulaHallazgosModelo> _lista;

        public ObservableCollection<CedulaHallazgosModelo> lista
        {
            get
            {
                return _lista;
        ...
        private CedulaHallazgosModelo _currentEntidadDetalle;

        public CedulaHallazgosModelo currentEntidadDetalle
        {
            get
            {
        ...
        public RelayCommand<CedulaHallazgosModelo> SelectionChangedCommand { get; set; }
        ...
        public HallazgosViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                case "cedulasHallazgos":
                    ...
                    _tokenRecepcionPadre = "datosEncargoCedulasHallazgosMenuPrincipal";//Permite captar los mensajes del  view model BalancesViewModel

                    _tokenEnvioDatosAHijo = "datosEncargoCedulasHallazgos";  //Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulasHallazgosController";

                    _tokenEnvioDatosAMenu = "Hallazgos" + "Cédulas" + "DetalleRegreso"; //Para regresar al menu anterior.
                    ...
                    break;
                case "SupervisionHallazgos":
                    _menuElegido = "Supervision";
                    _nombreopcionor = "Consulta de hallazgos";
                    #region Supervision Hallazgos
                    ...
                    _tokenRecepcionPadre = "Consulta de hallazgos" + "Supervision";//Permite captar los mensajes del  menú planificacion, corresponde a Indices
                    ...
                    #endregion Supervision  Hallazgos

                    break;
                case "SupervisionDetalleHallazgos":
                    _menuElegido = "Cedulas";
                    ...
                    _tokenEnvioDatosAMenu = "Consulta de hallazgos" + "Supervision"+ "DetalleRegreso"; //Para regresar al menu anterior.

                    #endregion

                    RegisterCommands();
                    _tablaDetalle = "Consulta de hallazgos";
                    #region  menu
            ...
            currentEntidadDetalle = new CedulaHallazgosModelo();
            _comando = 0;
            dlg = new DialogCoordinator();
            lista = new ObservableCollection<CedulaHallazgosModelo>();//Lista vacia no se conoce el encargo y el cliente
        ...
        private async void ControlRecepcionDatos(CedulaMsj msj)
        {
            ...
            //_tokenEnvioPadre = msj.tokenRespuestaController;
            //_tokenRecepcionSubMenu = msj.tokenRespuestaVista;
            ...
            //currentEntidad = CedulaModelo.FindMaestro(currentEncargo.idencargo, idtc, "Cédula de hallazgos");
        ...
        private void actualizarLista()
        {
            ...
            try
            {
                ...
                {
                    lista = CedulaHallazgosModelo.GetAllEdicion(currentEncargo, currentEntidad.idcedula);
                }
            }
            catch (Exception e)
            {
        ...
        public async void Editar()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                currentEntidadDetalle.fechacreadohallazgo = MetodosModelo.homologacionFecha();
                ECMainModel.TypeName = "CedulaHallazgosEditarView";
        ...
        public async void Consultar()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                currentEntidadDetalle.usuarioModelo = usuarioModelo;
                currentEntidadDetalle.fechacreadohallazgo = MetodosModelo.homologacionFecha();
                ECMainModel.TypeName = "CedulaHallazgosConsultarView";
                enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                if (result == MessageDialogResult.Affirmative)
                {
                    ...
                    if (lista.Where(x => x.IsSelected).Count() == 1)
                    {
                        ...
                        switch (CedulaModelo.evaluarBorrar(currentEntidad))
                        {
                            ...
                            case 1:
                                ...
                                switch (CedulaHallazgosModelo.Delete(currentEntidadDetalle))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                    ...
                    else
                    {
                        ...
                        ObservableCollection<CedulaHallazgosModelo> temporal = new ObservableCollection<CedulaHallazgosModelo>();
                        foreach (CedulaHallazgosModelo item in lista)
                        {
                            if (item.IsSelected)
                            {
                                switch (CedulaModelo.evaluarBorrar(currentEntidad))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error al consultar  " + item.titulohallazgo, "intentelo en otro momento");
                                        iniciarComando();
                                        //Hay error en el procedimiento
                                        break;
                                    case 0:
                                    ...
                                    default:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "No puede eliminarse " + item.titulohallazgo, "porque hay papeles referenciados");
                                        iniciarComando();
                                        break;
                                }
                            }
                        ...
                        if (temporal.Count > 0)
                        {
                            ...
                            switch (CedulaHallazgosModelo.Delete(temporal))
                            {
                                case -1:
                                    finComando();
                                    await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                ...
                if (result == MessageDialogResult.Affirmative)
                {
                    ...
                    if (lista.Where(x => x.IsSelected).Count() == 1)
                    {
                        ...
                        switch (CedulaModelo.evaluarBorrar(currentEntidad))
                        {
                            ...
                            case 1:
                                //Puede borrarse por completo
                                switch (CedulaHallazgosModelo.DeleteLogico(currentEntidadDetalle))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                    ...
                    else
                    {
                        ...
                        {
                            //caso de muchos registros
                            switch (CedulaHallazgosModelo.DeleteBorradoLogico(temporal))
                            {
                                case -1:
                                    finComando();
                                    await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
        ...
        public void Actualizar(ObservableCollection<CedulaHallazgosModelo> listaEntidad)
        {
            lista = listaEntidad;
        }
        ...
        public bool CanCommand()
        {
            if (!(currentEntidadDetalle == null))
            {
                try
                {
                    return currentEntidadDetalle.idhallazgo != 0;
                }
                catch (Exception)
                {
                    return false;
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<CedulaHallazgosModelo>(entidad =>
            {
        ...
        private async void aprobarPapel()
        {
            if (!(currentEntidad == null))
            {
                ...
                ECMainModel.TypeName = "CedulaHallazgosAprobarView";
                #region Configuracion
                currentEntidad.usuarioModelo = usuarioModelo;
                #endregion
                enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaHallazgosSupervisarView";
                    #region Configuracion
                    currentEntidad.usuarioModelo = usuarioModelo;
                    #endregion
                    enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidad == null))
            {
                ...
                if (estadoDocumento == 1) //Hay cero procedimientos diferentes a iniciados
                {
                    if (currentEntidad.referenciacedula != string.Empty)
                    {
                        ...
                        ECMainModel.TypeName = "CedulaHallazgosCerrarView";
                        #region Configuracion
                        currentEntidad.usuarioModelo = usuarioModelo;
                        #endregion
                        enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void vistaPapel()
        {
            ...
            currentEntidadDetalle.usuarioModelo = usuarioModelo;
            currentEntidadDetalle.fechacreadohallazgo = MetodosModelo.homologacionFecha();
            ECMainModel.TypeName = "CedulaHallazgosVerView";
            enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            //}
            //else
            //{
        ...
        public async void Importar()
        {
            ...
            if (result == MessageDialogResult.Affirmative)
            {
                ...
                //ECMainModel.TypeName = "CedulaHallazgosImportarView";
        ...
        private async Task<bool> ImportarMarcas()
        {
            ...
            ObservableCollection<MarcasEstandaresModelo> agregar = new ObservableCollection<MarcasEstandaresModelo>((from p in listaMarcasEstandares
                                                                                                                     where !(from ex in lista
                                                                                                                             select ex.titulohallazgo)
                                                                                                                            .Contains(p.marcame)
                                                                                                                     select p).ToList());
            //Convertir e importar
            if (agregar.Count > 0)
            {
                CedulaHallazgosModelo temporal = new CedulaHallazgosModelo();
                //Convertir 
                ...
                try
                {
                    ...
                    {
                        temporal.idhallazgo = 0;
                        temporal.idcedula = currentEntidad.idcedula;
                        temporal.titulohallazgo = item.marcame;
                        ...
                        //Guardar
                        switch (CedulaHallazgosModelo.Insert(temporal))
                        {
                            case 0://No se pudo insertar
