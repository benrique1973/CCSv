...
{
    public sealed class MarcasPresentacionViewModel : ViewModeloBase
    {
        ...
        public MarcasPresentacionViewModel()
        {

        }

        public MarcasPresentacionViewModel(string origen)
        {
            #region configuracion general
            enviarMensajeInhabilitar();
            _currentEntidad = new CedulaModelo();
            _currentEntidadDetalle = new CedulaMarcasModelo();
            _lista = new ObservableCollection<CedulaMarcasModelo>();
            ...
            switch (origen)
            {
                case "CedulaMarcas":
                    ...
                    _tokenEnvioCierre = "datosEncargoCedulasMarcasController";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Marcas";
                    break;
                case "IndiceCedulaMarcas":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
                    _tokenEnvioCierre = "datosControllerDetalleIndices";
                    _fuenteLlamado = 1;
                    _encabezadoPantalla = "Cédula de Marcas";
                    break;
                case "ImprimirIndiceCedulaMarcas":
                    _tokenRecepcion = "datosPadreDetalleIndices";  //Modificado
            ...
            Messenger.Default.Register<MarcasMsj>(this, tokenRecepcion, (ElementoMsj) => ControlDetalleHerramientoCrudMensaje(ElementoMsj));
        ...
        private void ControlDetalleHerramientoCrudMensaje(MarcasMsj ElementoMsj)
        {
            //Procesos normal
            ...
            llenadoDatos();
            //Desuscribir mensaje
            Messenger.Default.Unregister<MarcasMsj>(this, tokenRecepcion);//Proviene de pantalla principal
        ...
        private async void imprimirReporte()
        {
            ...
            if (resultk == MessageDialogResult.Affirmative)
            {
                ...
                EncabezadosSinPiesReporteMarcas ep = new EncabezadosSinPiesReporteMarcas();
                ...
                msj.TipoReporteAGenerar = TipoReporteAGenerar.CedulaMarcas;

                msj.EncabezadosSinPiesReporteMarcas = ep;
                msj.listaCedulaMarcas = lista;


                ReportesAImpresionMainModel.TypeName = "ReporteCedulaMarcas";
