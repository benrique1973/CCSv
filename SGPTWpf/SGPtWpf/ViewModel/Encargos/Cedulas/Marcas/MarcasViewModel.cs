...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Marcas
{
    ...
    public sealed class MarcasViewModel  : ViewModeloBase
    {
        ...
        private ObservableCollection<CedulaMarcasModelo> _SelectedItems;

        public ObservableCollection<CedulaMarcasModelo> SelectedItems
        {
            get
            {
        ...
        private ObservableCollection<CedulaMarcasModelo> _lista;

        public ObservableCollection<CedulaMarcasModelo> lista
        {
            get
            {
                return _lista;
        ...
        private CedulaMarcasModelo _currentEntidadDetalle;

        public CedulaMarcasModelo currentEntidadDetalle
        {
            get
            {
        ...
        public RelayCommand<CedulaMarcasModelo> SelectionChangedCommand { get; set; }
        ...
        public MarcasViewModel ()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public MarcasViewModel (string origen)//Documentacion/Carpetas
        {
            ...
            switch (origen)
            {
                case "cedulasMarcas":
                    ...
                    _tokenRecepcionPadre = "Marcas" + "Cédulas";//Permite captar los mensajes del  menú planificacion, corresponde a Indices

                    _tokenEnvioDatosAHijo = "datosEncargoCedulasMarcas";//Para control de los datos que  remite programas a sub-ventanas

                    _tokenRecepcionHijo = "datosEncargoCedulasMarcasController";

                    #endregion

                    RegisterCommands();
                    _tablaDetalle = "Marcas";
                    break;
            ...
            currentEntidadDetalle = new CedulaMarcasModelo();
            _comando = 0;
            dlg = new DialogCoordinator();
            lista = new ObservableCollection<CedulaMarcasModelo>();//Lista vacia no se conoce el encargo y el cliente
        ...
        private async void ControlRecepcionDatos(EncargosDatosMsj msj)
        {
            ...
            currentEntidad = CedulaModelo.FindMaestro(currentEncargo.idencargo, idtc, "Cédula de marcas");
            switch (currentEntidad.idcedula)
            {
                ...
                case 0:
                    ...
                    currentEntidad.titulocedula = "Cédula de marcas";
        ...
        private void actualizarLista()
        {
            ...
            try
            {
                ...
                {
                    lista = CedulaMarcasModelo.GetAllEdicion(currentEncargo,  currentEntidad.idcedula);
                }
            }
            catch (Exception e)
            {
        ...
        public void Nuevo()
        {
            ...
            currentEntidadDetalle = new CedulaMarcasModelo(currentEntidad, currentEncargo, usuarioModelo);
            currentEntidadDetalle.ordenma = lista.Count() + 1;
            ECMainModel.TypeName = "CedulaMarcasCrearview";
            #endregion
        ...
        public async void Editar()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                currentEntidadDetalle.fechahoyme= MetodosModelo.homologacionFecha();
                ECMainModel.TypeName = "CedulaMarcasEditarView";
        ...
        public async void Consultar()
        {
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                currentEntidadDetalle.usuarioModelo = usuarioModelo;
                currentEntidadDetalle.fechahoyme = MetodosModelo.homologacionFecha();
                ECMainModel.TypeName = "CedulaMarcasConsultarView";
                enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidadDetalle == null))
            {
                ...
                if (result == MessageDialogResult.Affirmative)
                {
                    ...
                    if (lista.Where(x => x.IsSelected).Count() == 1)
                    {
                        ...
                        switch (CedulaModelo.evaluarBorrar(currentEntidad))
                        {
                            ...
                            case 1:
                                ...
                                switch (CedulaMarcasModelo.Delete(currentEntidadDetalle))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                    ...
                    else
                    {
                        ...
                        ObservableCollection<CedulaMarcasModelo> temporal = new ObservableCollection<CedulaMarcasModelo>();
                        foreach (CedulaMarcasModelo item in lista)
                        {
                            if (item.IsSelected)
                            {
                                switch (CedulaModelo.evaluarBorrar(currentEntidad))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error al consultar  " + item.marcama, "intentelo en otro momento");
                                        iniciarComando();
                                        //Hay error en el procedimiento
                                        break;
                                    case 0:
                                    ...
                                    default:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "No puede eliminarse " + item.marcama, "porque hay papeles referenciados");
                                        iniciarComando();
                                        break;
                                }
                            }
                        ...
                        if (temporal.Count > 0)
                        {
                            ...
                            switch (CedulaMarcasModelo.Delete(temporal))
                            {
                                case -1:
                                    finComando();
                                    await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                ...
                if (result == MessageDialogResult.Affirmative)
                {
                    ...
                    if (lista.Where(x => x.IsSelected).Count() == 1)
                    {
                        ...
                        switch (CedulaModelo.evaluarBorrar(currentEntidad))
                        {
                            ...
                            case 1:
                                //Puede borrarse por completo
                                switch (CedulaMarcasModelo.DeleteLogico(currentEntidadDetalle))
                                {
                                    case -1:
                                        finComando();
                                        await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
                    ...
                    else
                    {
                        ...
                        {
                            //caso de muchos registros
                            switch (CedulaMarcasModelo.DeleteBorradoLogico(temporal))
                            {
                                case -1:
                                    finComando();
                                    await dlg.ShowMessageAsync(this, "Se produjo un error ", "intentelo en otro momento");
        ...
        public void Actualizar(ObservableCollection<CedulaMarcasModelo> listaEntidad)
        {
            lista = listaEntidad;
        }
        ...
        public bool CanCommand()
        {
            if (!(currentEntidadDetalle == null))
            {
                try
                {
                    return currentEntidadDetalle.idma != 0;
                }
                catch (Exception)
                {
                    return false;
        ...
        private void RegisterCommands()
        {
            ...
            SelectionChangedCommand = new RelayCommand<CedulaMarcasModelo>(entidad =>
            {
        ...
        private async void aprobarPapel()
        {
            if (!(currentEntidad == null))
            {
                ...
                ECMainModel.TypeName = "CedulaMarcasAprobarView";
                #region Configuracion
                currentEntidad.usuarioModelo = usuarioModelo;
                #endregion
                enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        {
            {
                if (!(currentEntidad == null))
                {
                    ...
                    ECMainModel.TypeName = "CedulaMarcasSupervisarView";
                    #region Configuracion
                    currentEntidad.usuarioModelo = usuarioModelo;
                    #endregion
                    enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
            ...
            if (!(currentEntidad == null))
            {
                ...
                if (estadoDocumento == 1) //Hay cero procedimientos diferentes a iniciados
                {
                    if (currentEntidad.referenciacedula != string.Empty)
                    {
                        ...
                        ECMainModel.TypeName = "CedulaMarcasCerrarView";
                        #region Configuracion
                        currentEntidad.usuarioModelo = usuarioModelo;
                        #endregion
                        enviarMensaje();  //Debe ir antes, porque evalua si la ventana es cero para enviarse
        ...
        private void vistaPapel()
        {
            ...
            currentEntidadDetalle.usuarioModelo = usuarioModelo;
            currentEntidadDetalle.fechahoyme = MetodosModelo.homologacionFecha();
            ECMainModel.TypeName = "CedulaMarcasVerView";
            enviarMensaje(); //Debe ir antes, porque evalua si la ventana es cero para enviarse
            //}
            //else
            //{
        ...
        public async void Importar()
        {
            ...
            if (result == MessageDialogResult.Affirmative)
            {
                ...
                //ECMainModel.TypeName = "CedulaMarcasImportarView";
        ...
        private async Task<bool> ImportarMarcas()
        {
            ...
            if (agregar.Count > 0)
            {
                CedulaMarcasModelo temporal = new CedulaMarcasModelo();
                //Convertir 
                ...
                try
                {
                    foreach (MarcasEstandaresModelo item in agregar)
                    {
                        ...
                        temporal.isuso = 0;
                        temporal.ordenma = orden;
                        orden++;
                        temporal.usuarioModelo = usuarioModelo;
                        //Guardar
                        switch (CedulaMarcasModelo.Insert(temporal))
                        {
                            case 0://No se pudo insertar
