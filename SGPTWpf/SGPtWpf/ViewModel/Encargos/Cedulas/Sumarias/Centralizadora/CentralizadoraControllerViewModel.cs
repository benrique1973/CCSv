...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Sumarias.Centralizadora
{
    ...
    public sealed class CentralizadoraControllerViewModel : ViewModeloBase
    {
        ...
        public CentralizadoraControllerViewModel()
        {
        }

        public CentralizadoraControllerViewModel(string origenLlamada)
        {
            ...
            {
                case "DocumentacionCedulaCentralizadora"://Llamada desde Documentacion/Carpetas
                    #region configuracion Documentacion
                    _tokenEnvio = "datosControllerEncargoCedulasSumariasCentralizadora";
