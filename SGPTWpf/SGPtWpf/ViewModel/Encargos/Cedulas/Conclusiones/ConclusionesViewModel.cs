...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Cedulas.Conclusiones
{

    public sealed class ConclusionesViewModel : ViewModeloBase
    {
        ...
        public ConclusionesViewModel()//Caso Encargo/PlanIndice
        {
        }

        //Llamado desde documentacion
        public ConclusionesViewModel(string origen)//Documentacion/Carpetas
        {
