...
namespace SGPTWpf.ViewModel.Encargos.Planificacion
{
    public sealed class PlanificacionViewModel : ViewModeloBase
    {
        ...
        #region tokenRecepcionMaterialidad

        private string _tokenRecepcionMaterialidad;
        private string tokenRecepcionMaterialidad
        {
            get { return _tokenRecepcionMaterialidad; }
            set { _tokenRecepcionMaterialidad = value; }
        }

        #endregion

        #region tokenRecepcionRiesgo

        private string _tokenRecepcionRiesgo;
        private string tokenRecepcionRiesgo
        {
            get { return _tokenRecepcionRiesgo; }
            set { _tokenRecepcionRiesgo = value; }
        }
        ...
        #region tokenRecepcionSubMenuMaterialidad
        private string _tokenRecepcionSubMenuMaterialidad;
        private string tokenRecepcionSubMenuMaterialidad
        {
            get { return _tokenRecepcionSubMenuMaterialidad; }
            set { _tokenRecepcionSubMenuMaterialidad = value; }
        }
        #endregion
        ...
        private PlanificacionModelo _currentEntidad;

        public PlanificacionModelo currentEntidad
        {
            get
            {
        ...
        private ObservableCollection<PlanificacionModelo> _listaVistas;

        public ObservableCollection<PlanificacionModelo> listaVistas
        {
            get
            {
                return _listaVistas;
        ...
        public PlanificacionViewModel()
        {
            ...
            _tokenRecepcionSeleccionCliente = "Planificación"+"ClienteSeleccionado";//Proviene de  EncargosControllerViewModel;
            _tokenEnvioPlanificacion = "PlanificacionDatos";
            _tokenRecepcionEncargos = "Planificación"+ "MenuEncargos";
            _tokenRecepcionProgramas= "inicioProgramas";
            _tokenRecepcionCuestionarios = "inicioCuestionarios";
            _tokenRecepcionIndices= "inicioEncargoDocumentacionPlanIndices";
            _tokenRecepcionSubMenuIndice = "PlanDetalleIndiceRegreso";

            _tokenRecepcionMaterialidad = "inicioEncargoDocumentacionPlanMaterialidad";
            _tokenRecepcionSubMenuMaterialidad = "PlanDetalleMaterialidadRegreso";

            _tokenRecepcionRiesgo = "inicioRiesgos";
            ...
            listaVistas= new ObservableCollection<PlanificacionModelo>(PlanificacionModelo.GetAll());
            ...
            Messenger.Default.Register<int>(this, tokenRecepcionSubMenuMaterialidad, (detalleTerminado) => ControltokenRecepcionSubMenuMaterialidad(detalleTerminado));

            currentEntidad = new PlanificacionModelo();
        }

        private void ControltokenRecepcionSubMenuMaterialidad(int detalleTerminado)
        {
            for (int i = 0; i < listaVistas.Count; i++)
            {
                if (listaVistas[i].tabla.Contains("Materialidad"))
                {
            ...
            {
                tokenEnvioPlanificacion = currentEntidad.ViewDisplay + "Planificación";
                Messenger.Default.Register<ComandoTerminado>(this, tokenEnvioPlanificacion, (comandoTerminado) => ControlComandoTerminado(comandoTerminado));
                cursorWindow = Cursors.Wait;
                currentEntidad.NavigateExecute();
                enviarMensajeDatos();
                //Reinicializando las vistas
                listaVistas = new ObservableCollection<PlanificacionModelo>(PlanificacionModelo.GetAll());
                foreach (PlanificacionModelo item in listaVistas)
                {
        ...
        private void ControlComandoTerminado(ComandoTerminado comandoTerminado)
        {
            ...
            Messenger.Default.Unregister<ComandoTerminado>(this, tokenEnvioPlanificacion);
            currentEntidad = new PlanificacionModelo();
        }
        ...
        private void enviarMensajeDatos()
        {
            ...
            Messenger.Default.Send(elemento, tokenEnvioPlanificacion);
        }
