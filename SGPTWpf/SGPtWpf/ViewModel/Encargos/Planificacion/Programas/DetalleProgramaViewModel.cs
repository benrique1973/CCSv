...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Planificacion.Programas

{
    ...
    public sealed class DetalleProgramaViewModel : ViewModeloBase
    {
        ...
        public DetalleProgramaViewModel(string origen)//Documentacion/Carpetas
        {
            ...
            _opcionMenuCrud = 0;
            _opcionMenuPrincipal = 0; //1 para  programa 1, para cuestionario
            _comando = 0;
            ...
            _currentPrograma = new ProgramaModelo();
            ...
            if (mensaje.mensaje)
            {
                ...
                switch (comando)
                {
                    case 1:
                        ...
                        { 
                        if ((ProgramaModelo.UpdateSumaModelo(currentPrograma)))
                        {
        ...
        public async void Borrar()
        {
            if (!(currentDetallePrograma == null))
            {
                ...
                {
                    await dlg.ShowMessageAsync(this, "El procedimiento esta ya en proceso, no puede eliminarse", "Puede realizar consulta únicamente");
                }
            }
            else
            {
        ...
        private void VistaPrograma()
        {
            ...
            comando = 5;
            //accesibilidadWindow = false;
            //opcionMenuPrincipal == 1)//1 Para programa 2 para cuestionario
