...
namespace SGPTWpf.SGPtWpf.ViewModel.Encargos.Planificacion.Programas
{
    public sealed class ProgramaPresentacionViewModel : ViewModeloBase
    {
        ...
        private void ControlDetalleHerramientoCrudMensaje(ProgramaDatosMsj herramientasModeloElementoMensajes)
        {
            ...
            {
                tokenEnvioCierre = "CierreEncargosPlanProgramaEncargos";
                //enviarMensajeInhabilitar();//Ventana main
                fuenteLlamado = 1;
                listaDetalleHerramienta = new ObservableCollection<DetalleProgramaModelo>(DetalleProgramaModelo.GetAllVista(currentEntidad.idprograma,currentEntidad.idencargoprograma));
